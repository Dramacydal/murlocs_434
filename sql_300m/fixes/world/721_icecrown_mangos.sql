...
UPDATE `creature_template` SET `unit_flags` = '0', `dynamicflags` = 0 WHERE `entry` IN (37972,37973,37970,38401,38784,38785,38399,38769,38770,38400,38771,38772);
...
(721002, 'Thanks everybody !\n', NULL, NULL, NULL, NULL, NULL, NULL, 'Спасибо всем!\n');
