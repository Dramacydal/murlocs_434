...
CREATE TABLE `warden_data_result` (
  ...
  `comment` text,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Warden data checks';

-- Warden data from TOM_RUS, R2 and TrinityCore
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (1, 113, '0590FC57AB448975FA46C314A8AB75AF96DF0FD0A3D9FB23', 'Afd32uu', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (2, 113, 'B797D0AF3164EE83167D5C054A511A5B209A70C6655C408B', 'IPSect', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (3, 113, '0A3C294B0799FD2C9EC17C1CCBCD174A51B6A2ECC62FEF17', 'IPSect', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (4, 113, '09BDABA6CB17BE561B4104124A3D0266C858D194A8765198', 'drvsys_mon', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (5, 113, 'A4D501A9DB9D84BD8695A8BF61FC853BF434D2D4B352C7A0', 'HideEx', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (6, 113, 'BFEF06E80472106B57B15D711F94A25243F6ABA7FE354C95', 'ndis_x86', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (7, 113, 'FBBA36D0FC5434D12EE1509E148FF908D51F18719CCBEABC', 'IPSect', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (8, 113, 'E3185EE4428291F9D2E4080C2EB1B19ADB005AD26EF0A993', 'IPSect', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (9, 113, '2357AD2012CEBA72283F93460AC5FF55E4E5719A5AB9F5B9', 'drvsys_mon', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (10, 113, '4BBF42A918109CC23F231B8E657076A213601AD681C032D1', 'HideEx', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (11, 113, '368334F9A3A549DFD3ABC9793E4EB83E837AA43F010354D1', 'ndis_x86', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (12, 113, '5DA702DF95570780875ADB4C64259E887CE0A867D9B67711', 'Afd32uu', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (13, 113, '49CA50FCF2699AE5F4A867156A5D8053C4239B36DACE170C', 'HideEx', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (14, 113, 'B9756E3E1093B54511AC5A7B85711E53CEBEA373EF4866EE', 'Afde32uu', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (15, 113, '8807783067F9FF2697A61DEE925760682EB894C6F0A798AE', 'Afd32uu', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (16, 113, '79747D68A5D6CD203671EF43029F17591E42BBCDB60B8B93', 'IPSect', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (17, 113, '2D14DD3BC859535580D8D9DC3BE7D59865A4E3FD112598A5', 'drvsys_mon', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (18, 113, '379E1F6905F203E1026DB54A58AF588EF5726D9F50FCF369', 'Afde32uu', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (19, 113, '08394625CCD77F36897EF283FAA0C019EE9F36775182584F', 'Afd32uu', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (20, 113, '0A268B6DB28320A1956B54C36C61C625B02A48A4768A0823', 'Afd32uu', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (21, 113, 'C584FF543FABE32DBA3206AB324CAFAD92497C4926BBF8B2', 'HideEx', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (22, 113, 'CD6B8F9D23612C807F7653D29F1F1C54BC8F917C5C5BD8F1', 'Afd32uu', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (23, 113, '85A32F8B5F8430A086D27E62EB17D878E49CE815F6AC91CA', 'IPSect', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (24, 113, '1B17998CD8E0CDA4D84B0A0F9DB05E536DACE0348A883D24', 'ndis_x86', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (25, 113, '3C9B0CC7FE020EEBD43E6B1D88EDDF0EC46AC35974765068', 'drvsys_mon', 0, 0, '', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (26, 217, '', 'WPESPY.DLL', 0, 0, '', 'WPE PRO - injected dll');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (27, 217, '', 'RPE.DLL', 0, 0, '', 'rEdoX Packet Editor - injected dll');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (28, 243, '', '', 4623652, 7, '578B7D08578BF1', 'Pointer to realmlist address');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (29, 243, '', '', 10010636, 12, '8166443FFF1FFFD9565CD95E', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (30, 243, '', '', 5417948, 5, '7734FF2485', 'FrameXML Signature Check');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (31, 243, '', '', 8491566, 5, '8B4D10890D', 'Lua DoString');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (32, 243, '', '', 5345746, 7, '746583F9177760', 'Lua Protection Patch');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (33, 243, '', '', 7246064, 6, '8950108B450C', 'Movement State related');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (34, 243, '', '', 7860712, 5, '742DF6407C', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (35, 243, '', '', 10714892, 8, 'BB8D243FD4D0313E', 'Wall Climb');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (36, 243, '', '', 9990741, 9, '8B878000000089463C', 'No Fall Damage Patch');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (37, 243, '', '', 10000022, 6, '894644894E54', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (38, 243, '', '', 7517484, 7, '7518683B010000', 'Follow Unit Check');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (39, 243, '', '', 5081862, 8, '6840AAB600C60200', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (40, 243, '', '', 7452688, 10, '8B81CC07000025000000', 'WoWEmuHacker Injection');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (41, 243, '', '', 5283280, 12, '558BECB8084E0000E8731DF0', 'AddChatMessage');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (42, 243, '', '', 5265823, 5, '72118B5518', 'Language Patch');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (43, 243, '', '', 11154396, 8, 'D893FEC0488C11C1', 'Jump Momentum');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (44, 243, '', '', 5284488, 9, '7507C7451400000000', 'Language Patch');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (45, 243, '', '', 5296496, 12, '558BEC81ECE80D00006A0AE8', 'SendChatMessage');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (46, 243, '', '', 7739760, 11, '01BE80000000E805B6FFFF', 'Jump related?');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (47, 243, '', '', 5124558, 5, '8BF08D4608', 'GetCharacterInfo');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (48, 243, '', '', 5090917, 8, 'E886EE1D0083C40C', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (49, 243, '', '', 10694516, 8, '2F549A416F12033B', 'Wall Climb');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (50, 243, '', '', 4609669, 5, '8986100F00', 'Login Password Pointer');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (51, 243, '', '', 5296823, 7, '75166824020000', 'Language patch (speak all)');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (52, 243, '', '', 4198410, 6, 'CCCCCCCCCCCC', NULL);
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (53, 243, '', '', 4609675, 5, '5E5DC20800', 'Loggin Result');
-- INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (54, 243, '', '', 11287980, 8, '04000000903C9F00', 'Parental Controls related');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (54, 243, '', '', 7452688, 10, '8B81CC07000025000000', 'WoWEmuHacker Injection');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (55, 243, '', '', 4618113, 10, 'FF1554F79D003B470C89', 'WS2_32.Send');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (56, 243, '', '', 5345728, 2, '558B', 'Lua Protection Remover');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (57, 243, '', '', 7726137, 2, '7414', 'Walk on Water Patch');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (58, 243, '', '', 8016620, 2, '7417', 'Collision M2 Special');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (59, 243, '', '', 8016079, 6, '0F8462010000', 'Collision M2 Regular');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (60, 243, '', '', 8054762, 2, '7506', 'Collision WMD');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (61, 243, '', '', 9995315, 2, '7544', 'Multi-Jump Patch');

-- Warden data from 300murlocs
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (62, 178, 'A444519C9C7A9FC73FF1E41094FDBEDE716DC068B82952BE', '', 40815, 81, '', 'WPE PRO: HackTool.Win32.Sniffer.WpePro.w');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (63, 178, 'A444519C9C7A9FC73FF1E41094FDBEDE716DC068B82952BE', '', 40623, 81, '', 'WPE PRO: HackTool.Win32.Sniffer.WpePro.y');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (64, 178, 'A444519CE7D2730A09B1BFE6F7EBCC62B46FC702D2875BB4', '', 361000, 84, '', 'rEdoX Packet Editor');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (65, 178, '33F11A8CA5BF8903F67BDF7A8D8C570CFEB62687610662BB', '', 16948, 27, '', 'AntiWarden tools: WardenNinja');

-- Warden data from trinity-core.ru
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (66, 243, '', '', '7728616', '1', '75', 'Simplefly');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (67, 243, '', '', '9993834', '1', '74', 'Simplefly');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (68, 243, '', '', '9993835', '1', '52', 'Simplefly');
INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (69, 243, '', '', '7277234', '8', '85F60F86F2000000', 'Simplefly - speedhack');

-- Original Warden data from TOM_RUS - NOW not currently used (only for BACKUP)
...
-- INSERT INTO `warden_data_result` VALUES (12, 243, '', '', 4623652, 7, '578B7D08578BF1', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (15, 243, '', '', 10010636, 12, '8166443FFF1FFFD9565CD95E', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (47, 243, '', '', 5417948, 5, '7734FF2485', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (51, 243, '', '', 8491566, 5, '8B4D10890D', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (59, 243, '', '', 5345746, 7, '746583F9177760', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (72, 243, '', '', 7246064, 6, '8950108B450C', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (88, 243, '', '', 7452688, 10, '8B81CC07000025000000', 'WowEmuHacker');
...
-- INSERT INTO `warden_data_result` VALUES (108, 191, '033BD6861DF7878DC9470EC2F699772BB2F3D5000490866F', '', 90202, 13, '', 'Ranger: what this?');
...
-- INSERT INTO `warden_data_result` VALUES (113, 243, '', '', 7860712, 5, '742DF6407C', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (118, 243, '', '', 10714892, 8, 'BB8D243FD4D0313E', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (121, 243, '', '', 9990741, 9, '8B878000000089463C', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (134, 243, '', '', 7452688, 10, '8B81CC07000025000000', 'WowEmuHacker');
...
-- INSERT INTO `warden_data_result` VALUES (193, 243, '', '', 7517484, 7, '7518683B010000', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (198, 243, '', '', 5081862, 8, '6840AAB600C60200', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (209, 243, '', '', 7452688, 10, '8B81CC07000025000000', 'WowEmuHacker');
...
-- INSERT INTO `warden_data_result` VALUES (237, 243, '', '', 5283280, 12, '558BECB8084E0000E8731DF0', 'cheats (unknown function)');
-- INSERT INTO `warden_data_result` VALUES (238, 191, 'AEA87B23CD9463E9693B6C053C1D9030F8E229DA308DBF29', '', 90202, 13, '', 'Ranger: what this?');
...
-- INSERT INTO `warden_data_result` VALUES (246, 243, '', '', 5265823, 5, '72118B5518', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (260, 243, '', '', 11154396, 8, 'D893FEC0488C11C1', 'cheats (unknown function)');
-- INSERT INTO `warden_data_result` VALUES (261, 243, '', '', 7452688, 10, '8B81CC07000025000000', 'WowEmuHacker');
...
-- INSERT INTO `warden_data_result` VALUES (288, 243, '', '', 5284488, 9, '7507C7451400000000', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (303, 191, 'BB795B4069F985BF44C7418DE264C3B0E9BA6D61A116FF81', '', 90202, 13, '', 'Ranger: what this?');
...
-- INSERT INTO `warden_data_result` VALUES (308, 243, '', '', 5296496, 12, '558BEC81ECE80D00006A0AE8', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (314, 243, '', '', 5124558, 5, '8BF08D4608', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (320, 243, '', '', 5090917, 8, 'E886EE1D0083C40C', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (329, 243, '', '', 10694516, 8, '2F549A416F12033B', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (343, 243, '', '', 4609669, 5, '8986100F00', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (349, 243, '', '', 5296823, 7, '75166824020000', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (385, 243, '', '', 7452688, 10, '8B81CC07000025000000', 'WowEmuHacker');
...
-- INSERT INTO `warden_data_result` VALUES (403, 243, '', '', 4609675, 5, '5E5DC20800', 'nude patch?');
...
-- INSERT INTO `warden_data_result` VALUES (438, 243, '', '', 7452688, 10, '8B81CC07000025000000', 'WowEmuHacker');
...
-- INSERT INTO `warden_data_result` VALUES (450, 243, '', '', 11154396, 8, 'D893FEC0488C11C1', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (471, 191, 'DF967A96C67C8D6CB1955D1CA06556F37EEFC88D26F1D684', '', 90202, 13, '', 'Ranger: what this?');
-- INSERT INTO `warden_data_result` VALUES (472, 191, '2BDB1F4509561B2F846AAE7A5354008215C1EF4BDD0EA1D1', '', 49347, 24, '', NULL);
-- INSERT INTO `warden_data_result` VALUES (473, 243, '', '', 5124558, 5, '8BF08D4608', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (476, 243, '', '', 7517484, 7, '7518683B010000', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (482, 243, '', '', 5417948, 5, '7734FF2485', 'cheats (unknown function)');
-- INSERT INTO `warden_data_result` VALUES (483, 243, '', '', 7246064, 6, '8950108B450C', 'cheats (unknown function)');
-- INSERT INTO `warden_data_result` VALUES (484, 243, '', '', 10714892, 8, 'BB8D243FD4D0313E', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (488, 243, '', '', 10010636, 12, '8166443FFF1FFFD9565CD95E', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (497, 243, '', '', 5296823, 7, '75166824020000', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (554, 243, '', '', 10694516, 8, '2F549A416F12033B', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (569, 243, '', '', 4609669, 5, '8986100F00', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (610, 191, '913AA6D16EBE73143FA4B4EF89C786668C6E7DD0B936DD18', '', 90202, 13, '', 'Ranger: what this?');
...
-- INSERT INTO `warden_data_result` VALUES (617, 243, '', '', 5265823, 5, '72118B5518', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (626, 243, '', '', 5090917, 8, 'E886EE1D0083C40C', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (652, 243, '', '', 5081862, 8, '6840AAB600C60200', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (655, 243, '', '', 8491566, 5, '8B4D10890D', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (667, 243, '', '', 4623652, 7, '578B7D08578BF1', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (694, 243, '', '', 9990741, 9, '8B878000000089463C', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (747, 243, '', '', 5345746, 7, '746583F9177760', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (758, 243, '', '', 5296496, 12, '558BEC81ECE80D00006A0AE8', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (763, 243, '', '', 5283280, 12, '558BECB8084E0000E8731DF0', 'cheats (unknown function)');
-- INSERT INTO `warden_data_result` VALUES (764, 178, 'D6DE200B631AF71BFBC76202D82649942FD6ED9BC4A9EF75', '', 198, 12, '', NULL);
-- INSERT INTO `warden_data_result` VALUES (765, 243, '', '', 7860712, 5, '742DF6407C', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (779, 191, '3BC0BE02AE0B6975974D3B13B811EC6BDACBF9EE122BE633', '', 90202, 13, '', 'Ranger: what this?');
...
-- INSERT INTO `warden_data_result` VALUES (783, 243, '', '', 7452688, 10, '8B81CC07000025000000', 'WowEmuHacker');
...
-- INSERT INTO `warden_data_result` VALUES (791, 243, '', '', 5284488, 9, '7507C7451400000000', 'cheats (unknown function)');
...
-- INSERT INTO `warden_data_result` VALUES (800, 243, '', '', 7452688, 10, '8B81CC07000025000000', 'WowEmuHacker');
...
-- Warden data from 300murlocs & other resources
-- INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (803, 217, '', 'WPESPY.DLL', 0, 0, '','WPE PRO');
-- INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (804, 178, 'A444519C9C7A9FC73FF1E41094FDBEDE716DC068B82952BE', '', 40815, 81, '', 'WPE PRO: HackTool.Win32.Sniffer.WpePro.w');
-- INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (805, 178, 'A444519C9C7A9FC73FF1E41094FDBEDE716DC068B82952BE', '', 40623, 81, '', 'WPE PRO: HackTool.Win32.Sniffer.WpePro.y');
-- INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (806, 217, '', 'RPE.DLL', 0, 0, '', 'rEdoX Packet Editor');
-- INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (807, 178, 'A444519CE7D2730A09B1BFE6F7EBCC62B46FC702D2875BB4', '', 361000, 84, '', 'rEdoX Packet Editor');
-- INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (808, 178, '33F11A8CA5BF8903F67BDF7A8D8C570CFEB62687610662BB', '', 16948, 27, '', 'AntiWarden tools: WardenNinja');

-- INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (809, 243, '', '', 5345728, 2, '558B' , 'LUA Protected function');
-- INSERT INTO `warden_data_result` (`id`, `check`, `data`, `str`, `address`, `length`, `result`, `comment`) VALUES (810, 152, '', 'World\\Maps\\Kalimdor\\Kalimdor_29_9.adt', 0, 0, '1F4C0E3222EE7302278D612628C21207FF5B3C10', 'Patch for The Path To GM Island (< 4.x.x Wow)');
