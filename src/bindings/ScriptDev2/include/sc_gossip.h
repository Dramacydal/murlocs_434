...
#define ADD_GOSSIP_ITEM_EXTENDED_ID(uiIcon, iTextId, uiSender, uiOptionId, iBoxMessage, uiBoxMoney, bCode)  PlayerTalkClass->GetGossipMenu().AddMenuItem(uiIcon, iTextId, uiSender, uiOptionId, iBoxMessage, uiBoxMoney, bCode)
