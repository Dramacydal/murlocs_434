...
struct MANGOS_DLL_DECL npc_muglashAI : public npc_escortAI
{
    ...
    void DoWaveSummon()
    {
        ...
        {
            case 1:
                m_creature->SummonCreature(NPC_WRATH_RIDER,     m_afFirstNagaCoord[0][0], m_afFirstNagaCoord[0][1], m_afFirstNagaCoord[0][2], 0.0f, EMPSUMMON_TIMED_OOC_DESPAWN, 60000);
                m_creature->SummonCreature(NPC_WRATH_SORCERESS, m_afFirstNagaCoord[1][0], m_afFirstNagaCoord[1][1], m_afFirstNagaCoord[1][2], 0.0f, EMPSUMMON_TIMED_OOC_DESPAWN, 60000);
                m_creature->SummonCreature(NPC_WRATH_RAZORTAIL, m_afFirstNagaCoord[2][0], m_afFirstNagaCoord[2][1], m_afFirstNagaCoord[2][2], 0.0f, EMPSUMMON_TIMED_OOC_DESPAWN, 60000);
                break;
            case 2:
                m_creature->SummonCreature(NPC_WRATH_PRIESTESS, m_afSecondNagaCoord[0][0], m_afSecondNagaCoord[0][1], m_afSecondNagaCoord[0][2], 0.0f, EMPSUMMON_TIMED_OOC_DESPAWN, 60000);
                m_creature->SummonCreature(NPC_WRATH_MYRMIDON,  m_afSecondNagaCoord[1][0], m_afSecondNagaCoord[1][1], m_afSecondNagaCoord[1][2], 0.0f, EMPSUMMON_TIMED_OOC_DESPAWN, 60000);
                m_creature->SummonCreature(NPC_WRATH_SEAWITCH,  m_afSecondNagaCoord[2][0], m_afSecondNagaCoord[2][1], m_afSecondNagaCoord[2][2], 0.0f, EMPSUMMON_TIMED_OOC_DESPAWN, 60000);
                break;
            case 3:
                m_creature->SummonCreature(NPC_VORSHA, m_fVorshaCoord[0], m_fVorshaCoord[1], m_fVorshaCoord[2], 0.0f, EMPSUMMON_TIMED_OOC_DESPAWN, 60000);
                break;
            case 4:
    ...
    void WaypointReached(uint32 uiPointId)
    {
        ...
        switch(uiPointId)
        {
            ...
            case 19:
                ...
                m_creature->SummonCreature(NPC_DURIEL, 1776.73f, -2049.06f, 109.83f, 1.54f, EMPSUMMON_TIMED_OOC_DESPAWN,25000);
                m_creature->SummonCreature(NPC_SILVERWING_SENTINEL, 1774.64f, -2049.41f, 109.83f, 1.40f, EMPSUMMON_TIMED_OOC_DESPAWN,25000);
                m_creature->SummonCreature(NPC_SILVERWING_WARRIOR, 1778.73f, -2049.50f, 109.83f, 1.67f, EMPSUMMON_TIMED_OOC_DESPAWN,25000);
                break;
            case 20:
...
struct MANGOS_DLL_DECL npc_feero_ironhandAI : public npc_escortAI
{
    ...
    void WaypointReached(uint32 uiPointId)
    {
        switch(uiPointId)
        {
            ...
            case 29:
                ...
                m_creature->SummonCreature(NPC_BALIZAR_THE_UMBRAGE, aEliteSummonPositions[0][0], aEliteSummonPositions[0][1], aEliteSummonPositions[0][2], aEliteSummonPositions[0][3], EMPSUMMON_TIMED_OOC_DESPAWN, 20000);
                m_creature->SummonCreature(NPC_ALIGAR_THE_TORMENTOR, aEliteSummonPositions[1][0], aEliteSummonPositions[1][1], aEliteSummonPositions[1][2], aEliteSummonPositions[1][3], EMPSUMMON_TIMED_OOC_DESPAWN, 20000);
                m_creature->SummonCreature(NPC_CAEDAKAR_THE_VICIOUS, aEliteSummonPositions[2][0], aEliteSummonPositions[2][1], aEliteSummonPositions[2][2], aEliteSummonPositions[2][3], EMPSUMMON_TIMED_OOC_DESPAWN, 20000);
                break;
            case 30:
                // Complete the quest
                if (Player* pPlayer = GetPlayerForEscort())
    ...
    void DoSpawnMob(uint32 uiEntry, float fDistance, float fAngle)
    {
        ...
        m_creature->SummonCreature(uiEntry, fX, fY, fZ, 0, EMPSUMMON_TIMED_OOC_DESPAWN, 20000);
    }
