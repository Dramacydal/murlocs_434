    ...
    void WaypointReached(uint32 uiPointId)
    {
        switch (uiPointId)
        {
            ...
            case 14:
                ...
                m_creature->SummonCreature(NPC_RAGING_AGAMAR, aBoarSpawn[0][0], aBoarSpawn[0][1], aBoarSpawn[0][2], 0, EMPSUMMON_TIMED_OOC_DESPAWN, 25000);
                m_creature->SummonCreature(NPC_RAGING_AGAMAR, aBoarSpawn[1][0], aBoarSpawn[1][1], aBoarSpawn[1][2], 0, EMPSUMMON_TIMED_OOC_DESPAWN, 25000);
                break;
            case 25:
            ...
            case 44:
                ...
                m_creature->SummonCreature(NPC_RAGING_AGAMAR, aBoarSpawn[2][0], aBoarSpawn[2][1], aBoarSpawn[2][2], 0, EMPSUMMON_TIMED_OOC_DESPAWN, 25000);
                m_creature->SummonCreature(NPC_RAGING_AGAMAR, aBoarSpawn[3][0], aBoarSpawn[3][1], aBoarSpawn[3][2], 0, EMPSUMMON_TIMED_OOC_DESPAWN, 25000);
                break;
            case 45:
