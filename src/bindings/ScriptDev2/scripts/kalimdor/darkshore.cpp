    ...
    void WaypointReached(uint32 uiPointId)
    {
        ...
        switch(uiPointId)
        {
            ...
            case 5:
                ...
                break;
            case 6:
                DoSpawnCreature(NPC_GRAVEL_SCOUT, -10.0f, 5.0f, 0.0f, 0.0f, EMPSUMMON_TIMED_OOC_DESPAWN, 30000);
                DoSpawnCreature(NPC_GRAVEL_BONE, -10.0f, 7.0f, 0.0f, 0.0f, EMPSUMMON_TIMED_OOC_DESPAWN, 30000);
                break;
            case 9:
            ...
            case 28:
                ...
                break;
            case 29:
                DoSpawnCreature(NPC_GRAVEL_SCOUT, -15.0f, 3.0f, 0.0f, 0.0f, EMPSUMMON_TIMED_OOC_DESPAWN, 30000);
                DoSpawnCreature(NPC_GRAVEL_BONE, -15.0f, 5.0f, 0.0f, 0.0f, EMPSUMMON_TIMED_OOC_DESPAWN, 30000);
                DoSpawnCreature(NPC_GRAVEL_GEO, -15.0f, 7.0f, 0.0f, 0.0f, EMPSUMMON_TIMED_OOC_DESPAWN, 30000);
                break;
            case 31:
...
struct MANGOS_DLL_DECL npc_volcorAI : public npc_escortAI
{
    ...
    void WaypointReached(uint32 uiPointId)
    {
        ...
        {
            case 4:
                m_creature->SummonCreature(NPC_BLACKWOOD_SHAMAN, aVolcorSpawnLocs[0].m_fX, aVolcorSpawnLocs[0].m_fY, aVolcorSpawnLocs[0].m_fZ, aVolcorSpawnLocs[0].m_fO, EMPSUMMON_TIMED_OOC_DESPAWN,20000);
                m_creature->SummonCreature(NPC_BLACKWOOD_URSA, aVolcorSpawnLocs[1].m_fX, aVolcorSpawnLocs[1].m_fY, aVolcorSpawnLocs[1].m_fZ, aVolcorSpawnLocs[1].m_fO, EMPSUMMON_TIMED_OOC_DESPAWN,20000);
                break;
            case 5:
                DoScriptText(SAY_FIRST_AMBUSH, m_creature);
                break;
            case 10:
                m_creature->SummonCreature(NPC_BLACKWOOD_SHAMAN, aVolcorSpawnLocs[2].m_fX, aVolcorSpawnLocs[2].m_fY, aVolcorSpawnLocs[2].m_fZ, aVolcorSpawnLocs[2].m_fO, EMPSUMMON_TIMED_OOC_DESPAWN,20000);
                m_creature->SummonCreature(NPC_BLACKWOOD_URSA, aVolcorSpawnLocs[3].m_fX, aVolcorSpawnLocs[3].m_fY, aVolcorSpawnLocs[3].m_fZ, aVolcorSpawnLocs[3].m_fO, EMPSUMMON_TIMED_OOC_DESPAWN,20000);
            case 12:
                m_creature->SummonCreature(NPC_BLACKWOOD_URSA, aVolcorSpawnLocs[4].m_fX, aVolcorSpawnLocs[4].m_fY, aVolcorSpawnLocs[4].m_fZ, aVolcorSpawnLocs[4].m_fO, EMPSUMMON_TIMED_OOC_DESPAWN, 20000);
                m_creature->SummonCreature(NPC_BLACKWOOD_URSA, aVolcorSpawnLocs[5].m_fX, aVolcorSpawnLocs[5].m_fY, aVolcorSpawnLocs[5].m_fZ, aVolcorSpawnLocs[5].m_fO, EMPSUMMON_TIMED_OOC_DESPAWN, 20000);
                break;
            case 14:
