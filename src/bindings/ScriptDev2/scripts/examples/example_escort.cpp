    ...
    void WaypointReached(uint32 uiWP)
    {
        switch (uiWP)
        {
            ...
            case 3:
                ...
                m_creature->SummonCreature(NPC_FELBOAR, m_creature->GetPositionX()+5.0f, m_creature->GetPositionY()+7.0f, m_creature->GetPositionZ(), 0.0f, EMPSUMMON_TIMED_OOC_DESPAWN, 3000);
                break;
            case 4:
