    ...
    void WaypointReached(uint32 i)
    {
        ...
        switch(i)
        {
            case 4:
                ...
                DoSpawnCreature(NPC_SLAVEBINDER, -10.0f, -5.0f, 0.0f, 0.0f, EMPSUMMON_TIMED_OOC_DESPAWN, 30000);
                DoSpawnCreature(NPC_SLAVEBINDER, -8.0f, 5.0f, 0.0f, 0.0f, EMPSUMMON_TIMED_OOC_DESPAWN, 30000);
                break;
            case 5:
