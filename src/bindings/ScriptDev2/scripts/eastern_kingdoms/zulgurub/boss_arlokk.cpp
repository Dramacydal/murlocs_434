...
struct MANGOS_DLL_DECL boss_arlokkAI : public ScriptedAI
{
    ...
    void DoSummonPhanters()
    {
        ...
        m_creature->SummonCreature(NPC_ZULIAN_PROWLER, -11532.7998f, -1649.6734f, 41.4800f, 0.0f, TEMPSUMMON_TIMED_OOC_DESPAWN, 15000);
        m_creature->SummonCreature(NPC_ZULIAN_PROWLER, -11532.9970f, -1606.4840f, 41.2979f, 0.0f, TEMPSUMMON_TIMED_OOC_DESPAWN, 15000);
    }
