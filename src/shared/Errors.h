...
#ifdef MANGOS_DEBUG_DEV
#  define MANGOS_ASSERT WPError
#  define MANGOS_ACE_ASSERT ACE_ASSERT
#else
//#  define MANGOS_ASSERT WPError                             // Error even if in release mode. //megai2: thx for this ... -_- disable
#  define MANGOS_ASSERT(x)
#  define MANGOS_ACE_ASSERT(x)
#endif
