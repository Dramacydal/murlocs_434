...
void WorldSession::SendPartyResult(PartyOperation operation, const std::string& member, PartyResult res, uint32 val)
{
...
void WorldSession::HandleGroupAcceptOpcode( WorldPacket & recv_data )
{
    ...
    {
        ERROR_LOG("HandleGroupAcceptOpcode: %s tried to accept an invite to his own group",
...
void WorldSession::HandleOptOutOfLootOpcode( WorldPacket & recv_data )
{
    ...
    if(unkn != 0)
        ERROR_LOG("CMSG_GROUP_PASS_ON_LOOT: activation not implemented!");
}
