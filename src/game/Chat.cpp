...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand achievementCriteriaCommandTable[] =
    {
        ...
        { "update",         SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleAchievementCriteriaUpdateCommand,"", NULL },
    ...
    static ChatCommand banCommandTable[] =
    {
        ...
        { "char",           SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleBanCharacterCommand,        "", NULL },
        { "characc",        SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleBanCharacterAccCommand,     "", NULL },
    ...
    static ChatCommand baninfoCommandTable[] =
    {
        ...
        { "char",           SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleBanInfoCharacterCommand,    "", NULL },
        { "characc",        SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleBanInfoCharacterAccCommand, "", NULL },
    ...
    static ChatCommand banlistCommandTable[] =
    {
        ...
        { "char",           SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleBanListCharacterCommand,    "", NULL },
        { "characc",        SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleBanListCharacterAccCommand, "", NULL },
    ...
    static ChatCommand characterAddonCommandTable[] =
    {
        { "set",            SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleCharacterAddonSetCommand,    "", NULL },
        { "remove",         SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleCharacterAddonRemoveCommand, "", NULL },
        { NULL,             0,                  false, NULL,                                            "", NULL }
    };
    ...
    static ChatCommand characterCommandTable[] =
    {
        ...
        { "addon",          SEC_ADMINISTRATOR,  true,  NULL,                                           "", characterAddonCommandTable},
        { "converttitles",  SEC_GAMEMASTER,     true,  &ChatHandler::HandleCharacterConvertTitlesCommand,  "", NULL },
        ...
        { "setaccount",     SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleCharacterSetAccountCommand, "", NULL },
    ...
    static ChatCommand debugCommandTable[] =
    {
        ...
        { "aura",           SEC_ADMINISTRATOR,  false, &ChatHandler::HandleDebugAuraCommand,                "", NULL },
        { "arena",          SEC_ADMINISTRATOR,  false, &ChatHandler::HandleDebugArenaCommand,               "", NULL },
        { "bg",             SEC_ADMINISTRATOR,  false, &ChatHandler::HandleDebugBattlegroundCommand,        "", NULL },
        { "bgevent",        SEC_ADMINISTRATOR,  false, &ChatHandler::HandleDebugBgEventCommand,             "", NULL },
        { "bgobjects",      SEC_ADMINISTRATOR,  false, &ChatHandler::HandleDebugBgObjectsCommand,           "", NULL },
        ...
        { "textemote",      SEC_GAMEMASTER,     false, &ChatHandler::HandleDebugTextEmoteCommand,           "", NULL },
        { "transport",      SEC_ADMINISTRATOR,  false, &ChatHandler::HandleDebugTransportCommand,           "", NULL },
    ...
    static ChatCommand gmCommandTable[] =
    {
        ...
        { "setview",        SEC_GAMEMASTER,     false, &ChatHandler::HandleSetViewCommand,             "", NULL },
        { "unview",         SEC_GAMEMASTER,     false, &ChatHandler::HandleUnViewCommand,              "", NULL },
    ...
    static ChatCommand listCommandTable[] =
    {
        ...
        { "unitevents",     SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleListUnitEventsCommand,      "", NULL },
    ...
    static ChatCommand modifyCommandTable[] =
    {
        ...
        { "soulshards",     SEC_MODERATOR,      false, &ChatHandler::HandleModifySoulShardsCommand,    "", NULL },
    ...
    static ChatCommand npcCommandTable[] =
    {
        ...
        { "setvehicleid",   SEC_ADMINISTRATOR,  false, &ChatHandler::HandleNpcSetVehicleIdCommand,     "", NULL },
        ...
        { "vehicleinfo",    SEC_ADMINISTRATOR,  false, &ChatHandler::HandleNpcVehicleInfoCommand,      "", NULL },
    ...
    static ChatCommand reloadCommandTable[] =
    {
        ...
        { "autobroadcasts", SEC_MODERATOR,      true,  &ChatHandler::HandleReloadAutobroadcasts,       "", NULL },
        ...
        { "allowed_pets",                SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadAllowedPetsCommand,             "", NULL },
        ...
        { "custom_areaflags",            SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadCustomAreaFlagsCommand,         "", NULL },
        ...
        { "disabled_spells",             SEC_ADMINISTRATOR, true,  &ChatHandler::HandleRealoadDisabledSpellsCommand,                "", NULL },
        ...
        { "phasedefinitions",            SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadPhaseDefinitionsCommand,        "", NULL },
        ...
        { "rfcconversion",               SEC_ADMINISTRATOR, true,  &ChatHandler::HandleRFCConversionCommand,                 "", NULL },
        ...
        { "transport_creatures",         SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadTransportCreaturesCommand,      "", NULL },
        { "vehicle_accessory",           SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadVehicleAccessoryCommand,        "", NULL },
    ...
    static ChatCommand serverCommandTable[] =
    {
        ...
        { "cleangmplayedtime",SEC_ADMINISTRATOR,true,  &ChatHandler::HandleServerCleanGmPlayedTimeCommand,"", NULL },
        ...
        { "mapstats",       SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleMapManagerInfoCommand,      "", NULL },
        { "clearmapstats",  SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleClearMapManagerInfoCommand, "", NULL },
    ...
    static ChatCommand unbanCommandTable[] =
    {
        ...
        { "char",           SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleUnBanCharacterCommand,    "", NULL },
        { "characc",        SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleUnBanCharacterAccCommand, "", NULL },
    ...
    {
        { "show",           SEC_ADMINISTRATOR,  false, &ChatHandler::HandleMmrShowCommand,              "", NULL },
        { "reset",          SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleMmrResetCommand,             "", NULL },
        { NULL,             0,                  true,  NULL,                                            "", NULL }
    };
    ...
    static ChatCommand wgCommandTable[] = 
    {
        ...
        { "playerstatus",   SEC_ADMINISTRATOR,  false, &ChatHandler::HandleWGPlayerStatusCommand,       "", NULL },
        { "timer",          SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleWGTimerCommand,              "", NULL },
        { "start",          SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleWGStartCommand,              "", NULL },
        { "status",         SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleWGStatusCommand,             "", NULL },
        { "end",            SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleWGEndCommand,                "", NULL },
        { "tower",          SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleWGTowerCommand,              "", NULL },
        { "wall",           SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleWGWallCommand,               "", NULL },
        { NULL,             0,                  true,  NULL,                                            "", NULL }
    };
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "maze",           SEC_ADMINISTRATOR,  true,  NULL,                                           "", mazeCommandTable     },
        ...
        { "allowspectate",  SEC_PLAYER,         false, &ChatHandler::HandleAllowSpectateCommand,       "", NULL },
        { "bg",             SEC_PLAYER,         false, &ChatHandler::HandleSetPreferedBGCommand,       "", NULL },
        { "checkdkquests",  SEC_GAMEMASTER,     false, &ChatHandler::HandleCharacterCheckDkQuestsCommand, "", NULL },
        { "dkstart",        SEC_GAMEMASTER,     false, &ChatHandler::HandleDkStartCommand,             "", NULL },
        { "ginfo",          SEC_GAMEMASTER,     true,  &ChatHandler::HandleGroupInfoCommand,           "", NULL },
...
bool ChatHandler::HasLowerSecurityAccount(WorldSession* target, uint32 target_account, bool strong)
{
    ...
    if (GetAccessLevel() > SEC_CURATOR && !strong && !sWorld.getConfig(CONFIG_BOOL_GM_LOWER_SECURITY))
        return false;
...
void ChatHandler::CheckIntegrity( ChatCommand *table, ChatCommand *parentCommand )
{
    for(uint32 i = 0; table[i].Name != NULL; ++i)
    {
        ...
        if (command->ChildCommands)
        {
            ...
            {
                if (parentCommand)
                    ERROR_LOG("Subcommand '%s' of command '%s' have handler and subcommands in same time, must be used '' subcommand for handler instead.",
                        command->Name, parentCommand->Name);
                else
                    ERROR_LOG("First level command '%s' have handler and subcommands in same time, must be used '' subcommand for handler instead.",
                        command->Name);
            }

            if (parentCommand && strlen(command->Name)==0)
                ERROR_LOG("Subcommand '' of command '%s' have subcommands", parentCommand->Name);
        ...
        {
            if (parentCommand)
                ERROR_LOG("Subcommand '%s' of command '%s' not have handler and subcommands in same time. Must have some from its!",
                    command->Name, parentCommand->Name);
            else
                ERROR_LOG("First level command '%s' not have handler and subcommands in same time. Must have some from its!",
                    command->Name);
        }
    }
}
        ...
        case CHAT_COMMAND_OK:
        {
            ...
            if ((this->*(command->Handler))((char*)text))   // text content destroyed at call
            {
                if (command->SecurityLevel > SEC_PLAYER)
                {
                    ...
                    if(m_session && m_session->GetSecurity() < SEC_CONSOLE)
                    {
                        Player* p = m_session->GetPlayer();
                        ObjectGuid sel_guid = p->GetSelectionGuid();
                        CharacterDatabase.escape_string(fullcmd);
                        CharacterDatabase.PExecute("INSERT INTO gmlog_commands (command, account, player, posX, posY, posZ, selected_type, selected_guid, map, ip, time) VALUES ('%s', '%u', '%s', '%f', '%f', '%f', '%s', '%u', '%u', '%s', NOW())",
                            fullcmd.c_str(), m_session->GetAccountId(), p->GetGuidStr().c_str(), p->GetPositionX(), p->GetPositionY(), p->GetPositionZ(), sel_guid.GetString().c_str(), p->GetObjectGuid().GetCounter(), p->GetMapId(), m_session->GetRemoteAddress().c_str());
                    }
                }
            }
