...
class MANGOS_DLL_SPEC ChatHandler
{
    ...
    protected:
        ...
        bool HandleCharDisplayMainhandCommand(char* args);
        bool HandleCharDisplayHeadCommand(char* args);
        bool HandleCharDisplayShouldersCommand(char* args);
        bool HandleCharDisplayChestCommand(char* args);
        bool HandleCharDisplayWaistCommand(char* args);
        bool HandleCharDisplayLegsCommand(char* args);
        bool HandleCharDisplayFeetCommand(char* args);
        bool HandleCharDisplayWristsCommand(char* args);
        bool HandleCharDisplayHandsCommand(char* args);
        bool HandleCharDisplayBackCommand(char* args);
        bool HandleCharDisplayOffhandCommand(char* args);
        bool HandleCharDisplayRangedCommand(char* args);

        bool HandleVoteMuteCommand(char* args);
        bool HandleVoteYesCommand(char* args);
        bool HandleVoteNoCommand(char* args);
        ...
        bool HandleAchievementCriteriaUpdateCommand(char* args);
        ...
        bool HandleBanListCharacterAccCommand(char* args);
        ...
        bool HandleCharacterConvertTitlesCommand(char* args);
        bool HandleCharacterCheckDkQuestsCommand(char* args);
        ...
        bool HandleCharacterSetAccountCommand(char* args);

        bool HandleDebugAnimCommand(char* args);
        bool HandleDebugTextEmoteCommand(char* args);
        bool HandleDebugArenaCommand(char* args);
        bool HandleDebugBattlegroundCommand(char* args);
        bool HandleDebugBgEventCommand(char* args);
        bool HandleDebugBgObjectsCommand(char* args);
        bool HandleDebugBgOpenDoorEventCommand(char* args);
        bool HandleDebugDistanceCommand(char* args);
        ...
        bool HandleDebugAuraCommand(char* args);
        ...
        bool HandleListUnitEventsCommand(char* args);
        ...
        bool HandleModifySoulShardsCommand(char* args);
        ...
        bool HandleCharacterAddonSetCommand(char* args);
        bool HandleCharacterAddonRemoveCommand(char* args);
        ...
        bool HandleNpcOwnerInfoCommand(char* args);
        bool HandleNpcVehicleInfoCommand(char* args);
        ...
        bool HandleNpcSetVehicleIdCommand(char* args);
        ...
        bool HandleWGTimerCommand(char* args);
        bool HandleWGStartCommand(char* args);
        bool HandleWGEndCommand(char* args);
        bool HandleWGTowerCommand(char* args);
        bool HandleWGWallCommand(char* args);
        ...
        bool HandleReloadAutobroadcasts(char* args);
        ...
        bool HandleReloadAllowedPetsCommand(char* args);
        ...
        bool HandleReloadCustomAreaFlagsCommand(char* args);
        ...
        bool HandleRFCConversionCommand(char* args);
        ...
        bool HandleReloadTransportCreaturesCommand(char* args);
        bool HandleReloadSpellPetAurasCommand(char* args);
        bool HandleReloadVehicleAccessoryCommand(char* args);
        ...
        bool HandleServerCleanGmPlayedTimeCommand(char* args);
        ...
        bool HandleUnBanCharacterAccCommand(char* args);
        ...
        bool HandleUnViewCommand(char* args);
        ...
        bool HandleGetFromBackupCommand(char* args);
        bool HandleDkStartCommand(char* args);
        bool HandleGroupInfoCommand(char* args);
        bool HandleAllowSpectateCommand(char* args);
        bool HandleSpectateCommand(char* args);
        bool HandleUnSpectateCommand(char* args);

        bool HandleSetPreferedBGCommand(char* args);
        bool HandleLeaveVehicleCommand(char* args);

        bool HandleMmrShowCommand(char* args);
        bool HandleMmrResetCommand(char* args);
        ...
        bool HandleBanListAccHelper(QueryResult* result);
        bool HandleBanListCharHelper(QueryResult* result);
        bool HandleBanHelper(BanMode mode, char* args);
        bool HandleBanInfoAccHelper(uint32 accountid, char const* accountname);
        bool HandleBanInfoCharHelper(uint32 guid, char const* name);
