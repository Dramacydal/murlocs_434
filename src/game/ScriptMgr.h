...
class ScriptMgr
{
    public:
        ...
        uint32 GetScriptNamesSize() { return m_scriptNames.size() * sizeof(m_scriptNames.begin()); }
        uint32 GetAreaTriggerScriptsSize() { return m_AreaTriggerScripts.size() * sizeof(m_AreaTriggerScripts.begin()->second); }
