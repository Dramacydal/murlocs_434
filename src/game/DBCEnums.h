...
enum AchievementFlags
{
    ...
    ACHIEVEMENT_FLAG_PLAY_NO_VISUAL         = 0x00000004,   // ACHIEVEMENT_FLAG_HIDDEN_TILL_AWARDED Store only max value? used only in "Reach level xx"
...
{
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_SOURCE_DRUNK_VALUE           = 1, // NYI
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_UNK2                         = 2,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_ITEM_LEVEL                   = 3,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_TARGET_CREATURE_ENTRY        = 4,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_TARGET_MUST_BE_PLAYER        = 5,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_TARGET_MUST_BE_DEAD          = 6,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_TARGET_MUST_BE_ENEMY         = 7,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_SOURCE_HAS_AURA              = 8,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_TARGET_HAS_AURA              = 10,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_TARGET_MUST_BE_MOUNTED       = 11,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_ITEM_QUALITY_MIN             = 14,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_ITEM_QUALITY_EQUALS          = 15,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_UNK16                        = 16,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_SOURCE_AREA_OR_ZONE          = 17,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_TARGET_AREA_OR_ZONE          = 18,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_MAP_DIFFICULTY               = 20,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_TARGET_CREATURE_YIELDS_XP    = 21, // NYI
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_ARENA_TYPE                   = 24, // NYI
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_SOURCE_RACE                  = 25,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_SOURCE_CLASS                 = 26,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_TARGET_RACE                  = 27,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_TARGET_CLASS                 = 28,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_MAX_GROUP_MEMBERS            = 29,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_TARGET_CREATURE_TYPE         = 30,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_SOURCE_MAP                   = 32,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_ITEM_CLASS                   = 33,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_ITEM_SUBCLASS                = 34,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_COMPLETE_QUEST_NOT_IN_GROUP  = 35, // NYI
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_MIN_PERSONAL_RATING          = 37, // NYI (when implementing don't forget about ACHIEVEMENT_CRITERIA_CONDITION_NO_LOSE)
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_TITLE_BIT_INDEX              = 38,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_SOURCE_LEVEL                 = 39,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_TARGET_LEVEL                 = 40,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_TARGET_ZONE                  = 41,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_TARGET_HEALTH_PERCENT_BELOW  = 46,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_UNK55                        = 55,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_MIN_ACHIEVEMENT_POINTS       = 56,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_REQUIRES_LFG_GROUP           = 58, // NYI
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_UNK60                        = 60,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_REQUIRES_GUILD_GROUP         = 61,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_GUILD_REPUTATION             = 62,
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_RATED_BATTLEGROUND           = 63, // NYI
    ACHIEVEMENT_CRITERIA_MORE_REQ_TYPE_PROJECT_RARITY               = 65,
...
{
    SPELL_CATEGORY_FLAG_NONE    = 0x0,
    SPELL_CATEGORY_FLAG_UNK1    = 0x1,                      // finishing move and repair bot
    SPELL_CATEGORY_FLAG_UNK2    = 0x2,                      // ranged weapon
    SPELL_CATEGORY_FLAG_POTION  = 0x4,                      // potions
    SPELL_CATEGORY_FLAG_WEEKLY  = 0x8,                      // weekly spells - profession researches
};
...
enum VehicleSeatFlags
{
    ...
    SEAT_FLAG_CAN_CONTROL           = 0x00000800,           // Can control vehicle
...
enum VehicleSeatFlagsB
{
    ...
    SEAT_FLAG_B_CANSWITCH                = 0x04000000,           // can switch seats
    SEAT_FLAG_B_VEHICLE_PLAYERFRAME_UI   = 0x80000000,           // Lua_UnitHasVehiclePlayerFrameUI - actually checked for flagsb &~ 0x80000000
};
