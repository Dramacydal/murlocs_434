...
{
    return spellProto->Id == 42292 || spellProto->Id == 53490 ||
        spellProto->Id == 59752 || spellProto->Id == 65547;
...
bool IsPositiveAura(SpellEntry const * spellInfo);
bool IsPositiveAura(SpellEntry const * spellInfo, SpellEffectIndex effIndex);
...
class SpellMgr
{
    ...
    public:
        ...
        static bool IsStackableSpellAuraHolder(SpellEntry const *spellInfo, Unit const* unit);
...
MANGOS_DLL_SPEC uint32 _GetFirstSpellInChain(uint32 spell_id);
MANGOS_DLL_SPEC SpellLearnSkillNode const* _GetSpellLearnSkill(uint32 spell_id);

//enum
//{
//    BUFF_TYPE_AP_PCT            = 0x00000001,
//    BUFF_TYPE_AP_FLAT           = 0x00000001,
//    BUFF_TYPE_ARMOR              = 0x00000001,
//    BUFF_TYPE_ALL_STATS_PCT              = 0x00000001,
//    BUFF_TYPE_ALL_STATS_FLAT              = 0x00000001,
//    BUFF_TYPE_AGILITY              = 0x00000001,
//    BUFF_TYPE_STRENGTH
//    BUFF_TYPE_INTELLECT              = 0x00000001,
//    BUFF_TYPE_SPIRIT              = 0x00000001,
//    BUFF_TYPE_STAMINA              = 0x00000001,
//    BUFF_TYPE_MELEE_CRIT              = 0x00000001,
//    BUFF_TYPE_SPELL_CRIT              = 0x00000001,
//    BUFF_TYPE_HASTE_ALL              = 0x00000001,
//    BUFF_TYPE_HASTE_MELEE              = 0x00000001,
//    BUFF_TYPE_HASTE_SPEL              = 0x00000001,
//    BUFF_TYPE_HEALTH              = 0x00000001,
//    BUFF_TYPE_MP5
//    BUFF_TYPE_
//};
