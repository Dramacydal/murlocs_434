...
#pragma pack(push,1)
    ...
    public:
        enum eFlags{
            ...
            Mask_Unused = No_Spline|Enter_Cycle|Frozen|Unknown6|Unknown7|Unknown8|Unknown10|Unknown11|Unknown12|Unknown13,
        };
        ...
        void EnableTransport()           { raw() = (raw() & ~Mask_No_Monster_Move)                      | On_Transport;}
