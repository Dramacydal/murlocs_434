...
uint32 BattleGroundAB::GetPlayerScore(Player *Source, uint32 type)
{
    ...
    {
        case SCORE_BASES_ASSAULTED:
            return ((BattleGroundABScore*)itr->second)->BasesAssaulted;
        case SCORE_BASES_DEFENDED:
            return ((BattleGroundABScore*)itr->second)->BasesDefended;
    }

    return BattleGround::GetPlayerScore(Source, type);
}

void BattleGroundAB::CheckBuggers()
{
