...
void InitializeOpcodes()
{
    ...
    OPCODE(CMSG_RIDE_VEHICLE_INTERACT,                   STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleEnterPlayerVehicle        );
    ...
    OPCODE(CMSG_ITEM_PURCHASE_REFUND,                    STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleItemRefund                );
    ...
    OPCODE(CMSG_CHAR_FACTION_CHANGE,                     STATUS_AUTHED,   PROCESS_THREADUNSAFE, &WorldSession::HandleCharFactionOrRaceChangeOpcode );
    ...
    OPCODE(CMSG_CHAR_RACE_CHANGE,                        STATUS_AUTHED,   PROCESS_THREADUNSAFE, &WorldSession::HandleCharFactionOrRaceChangeOpcode );
    ...
    OPCODE(CMSG_LF_GUILD_ADD_RECRUIT,                    STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildFinderAddRecruit     );
    OPCODE(CMSG_LF_GUILD_BROWSE,                         STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildFinderBrowse         );
    OPCODE(CMSG_LF_GUILD_DECLINE_RECRUIT,                STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildFinderDeclineRecruit );
    OPCODE(CMSG_LF_GUILD_GET_APPLICATIONS,               STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildFinderGetApplications);
    OPCODE(CMSG_LF_GUILD_GET_RECRUITS,                   STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildFinderGetRecruits    );
    OPCODE(CMSG_LF_GUILD_POST_REQUEST,                   STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildFinderPostRequest    );
    OPCODE(CMSG_LF_GUILD_REMOVE_RECRUIT,                 STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildFinderRemoveRecruit  );
    OPCODE(CMSG_LF_GUILD_SET_GUILD_POST,                 STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildFinderSetGuildPost   );
    ...
    //OPCODE(CMSG_LFG_GET_PLAYER_INFO,                     STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    OPCODE(CMSG_LFG_LFR_JOIN,                            STATUS_UNHANDLED,PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    OPCODE(CMSG_LFG_LFR_LEAVE,                           STATUS_UNHANDLED,PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    //OPCODE(CMSG_LFG_PARTY_LOCK_INFO_REQUEST,             STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL                     );
    ...
    OPCODE(CMSG_LFG_SET_COMMENT,                         STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::HandleLfgSetCommentOpcode       );
    ...
    //OPCODE(CMSG_SEARCH_LFG_JOIN,                         STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfrJoinOpcode           );
    ...
    OPCODE(SMSG_LFG_SLOT_INVALID,                        STATUS_UNHANDLED,PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    ...
    OPCODE(SMSG_LFG_UPDATE_SEARCH,                       STATUS_UNHANDLED,PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    OPCODE(SMSG_LFG_UPDATE_STATUS,                       STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    OPCODE(SMSG_LFG_UPDATE_STATUS_NONE,                  STATUS_UNHANDLED,PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    OPCODE(SMSG_OPEN_LFG_DUNGEON_FINDER,                 STATUS_UNHANDLED,PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               ); // aka SMSG_LFG_OPEN_FROM_GOSSIP
};
