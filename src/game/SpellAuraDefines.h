...
enum AuraType
{
    ...
    SPELL_AURA_POWER_BURN_ENERGY = 162,
    ...
    SPELL_AURA_MOD_DAMAGE_DONE_BY_MECHANIC = 276,           // Only "Test Mod Damage % Mechanic" spell, possible mod damage done
    ...
    SPELL_AURA_327 = 327,
    SPELL_AURA_PROC_ON_TARGET_AMOUNT = 328,
    SPELL_AURA_MOD_RUNIC_POWER_GAIN = 329,
