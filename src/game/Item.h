...
class MANGOS_DLL_SPEC Item : public Object
{
    public:
        ...
        void SetRefundable(bool apply, bool changestate = true, uint32 moneyCost = 0, uint32 extendedCost = 0);
        ...
        bool UpdateRefundablePlayedTime();
        bool UpdateSoulboundPlayedTime();
        bool IsExpired() const;
        bool HasRecipientWithGuid(ObjectGuid guid) const;

        ObjectGuid GetRefundRecipient() { return m_refundRecipient; }
