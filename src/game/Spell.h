...
enum SpellState
{
    SPELL_STATE_PREPARING = 0,
    SPELL_STATE_CASTING   = 1,
    SPELL_STATE_FINISHED  = 2,
...
class Spell
{
    ...
    public:
        void DoSummonSpecialPets(SpellEffectEntry const* effect);
        ...
        SpellCastResult CheckOrTakeRunePower(bool take, bool hit = false);
        ...
        bool CheckTargetCreatureType(Unit* target, uint32 effMask = (1 << EFFECT_INDEX_0) | (1 << EFFECT_INDEX_1) | (1 << EFFECT_INDEX_2)) const;
        ...
        static bool CanReflect(SpellEntry const * spellInfo);
...
class SpellEvent : public BasicEvent
{
    public:
        ...
        char const * GetName() const override { return "SpellEvent"; }

        Spell const* GetSpell() { return m_Spell; }
