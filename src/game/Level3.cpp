...
bool ChatHandler::HandleReloadAllLootCommand(char* /*args*/)
{
    ...
    LoadLootTables();
    sWorld.SendGMGlobalText("DB tables `*_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadAllQuestCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB tables `*_questrelation` and `*_involvedrelation` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadAllScriptsCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB tables `*_scripts` reloaded.");
...
bool ChatHandler::HandleReloadAutobroadcasts(char* /*args*/)
{
    sLog.outString("Re-Loading Autobroadcasts...");
    sWorld.LoadAutoBroadcasts();
    sWorld.SendGMGlobalText("DB tables `autobroadcast` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadConfigCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("World config settings reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadAchievementCriteriaRequirementCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `achievement_criteria_requirement` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadAchievementRewardCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `achievement_reward` reloaded.");
    return true;
}

bool ChatHandler::HandleReloadAllowedPetsCommand(char* /*args*/)
{
    sLog.outString("Re-Loading Allowed Pets...");
    sObjectMgr.LoadAllowedPets();
    sWorld.SendGMGlobalText("DB table `allowed_pets` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadAreaTriggerTavernCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `areatrigger_tavern` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadAreaTriggerTeleportCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `areatrigger_teleport` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadCommandCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `command` will be reloaded at next chat command use.");
    return true;
}
...
bool ChatHandler::HandleReloadCreatureQuestRelationsCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `creature_questrelation` (creature quest givers) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadCreatureQuestInvRelationsCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `creature_involvedrelation` (creature quest takers) reloaded.");
    return true;
}

bool ChatHandler::HandleReloadCustomAreaFlagsCommand(char* /*args*/)
{
    sLog.outString("Re-Loading custom areaflags...");
    sObjectMgr.LoadCustomAreaFlags();
    sWorld.SendGMGlobalText("DB table `custom_areaflags` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadGossipMenuCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `gossip_menu` and `gossip_menu_option` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadGossipScriptsCommand(char* args)
{
    ...
    if (*args!='a')
        sWorld.SendGMGlobalText("DB table `gossip_scripts` reloaded.");
...
bool ChatHandler::HandleReloadGOQuestRelationsCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `gameobject_questrelation` (gameobject quest givers) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadGOQuestInvRelationsCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `gameobject_involvedrelation` (gameobject quest takers) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadQuestAreaTriggersCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `areatrigger_involvedrelation` (quest area triggers) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadQuestTemplateCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `quest_template` (quest definitions) reloaded.");

    /// dependent also from `gameobject` but this table not reloaded anyway
    sLog.outString( "Re-Loading GameObjects for quests..." );
    sObjectMgr.LoadGameObjectForQuests();
    sWorld.SendGMGlobalText("Data GameObjects for quests reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesCreatureCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `creature_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesDisenchantCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `disenchant_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesFishingCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `fishing_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesGameobjectCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `gameobject_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesItemCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `item_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesMillingCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `milling_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesPickpocketingCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `pickpocketing_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesProspectingCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `prospecting_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesMailCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `mail_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesReferenceCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `reference_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesSkinningCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `skinning_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesSpellCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `spell_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadMangosStringCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `mangos_string` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadNpcGossipCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `npc_gossip` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadNpcTextCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `npc_text` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadNpcTrainerCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `npc_trainer_template` reloaded.");

    sLog.outString( "Re-Loading `npc_trainer` Table!" );
    sObjectMgr.LoadTrainers();
    sWorld.SendGMGlobalText("DB table `npc_trainer` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadNpcVendorCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `npc_vendor_template` reloaded.");

    sLog.outString( "Re-Loading `npc_vendor` Table!" );
    sObjectMgr.LoadVendors();
    sWorld.SendGMGlobalText("DB table `npc_vendor` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadPointsOfInterestCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `points_of_interest` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadQuestPOICommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB Table `quest_poi` and `quest_poi_points` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellClickSpellsCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `npc_spellclick_spells` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadReservedNameCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `reserved_name` (player reserved names) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadReputationRewardRateCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `reputation_reward_rate` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadReputationSpilloverTemplateCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `reputation_spillover_template` reloaded.");
    return true;
}

bool ChatHandler::HandleRFCConversionCommand(char* /*args*/)
{
    sLog.outString("Re-Loading Race/Faction change Tables!");
    sObjectMgr.LoadRFCConversionData();
    sWorld.SendGMGlobalText("Race/Faction change conversion tables reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSkillDiscoveryTemplateCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `skill_discovery_template` (recipes discovered at crafting) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSkillExtraItemTemplateCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `skill_extra_item_template` (extra item creation when crafting) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSkillFishingBaseLevelCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `skill_fishing_base_level` (fishing base level for zone/subzone) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellAreaCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `spell_area` (spell dependences from area/quest/auras state) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellBonusesCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `spell_bonus_data` (spell damage/healing coefficients) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellChainCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `spell_chain` (spell ranks) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellElixirCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `spell_elixir` (spell elixir types) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellLearnSpellCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `spell_learn_spell` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellProcEventCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `spell_proc_event` (spell proc trigger requirements) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellProcItemEnchantCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `spell_proc_item_enchant` (item enchantment ppm) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellScriptTargetCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `spell_script_target` (spell targets selection in case specific creature/GO requirements) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellTargetPositionCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `spell_target_position` (destination coordinates for spell targets) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellThreatsCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `spell_threat` (spell aggro definitions) reloaded.");
    return true;
}

bool ChatHandler::HandleReloadTransportCreaturesCommand(char* /*args*/)
{
    sLog.outString( "Re-Loading transport creatures database...");
    sMapMgr.LoadTransportCreatures();
    sWorld.SendGMGlobalText("DB table `transport_creatures` reloaded.");
    return true;
}

bool ChatHandler::HandleReloadVehicleAccessoryCommand(char* /*args*/)
{
    sLog.outString("Re-Loading vehicle_accessory table...");
    sObjectMgr.LoadVehicleAccessories();
    sWorld.SendGMGlobalText("DB table `vehicle_accessory` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellPetAurasCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `spell_pet_auras` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadPageTextsCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `page_texts` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadItemEnchantementsCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `item_enchantment_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadItemConvertCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `item_convert` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadItemRequiredTragetCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `item_required_target` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadBattleEventCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `gameobject_battleground` and `creature_battleground` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadEventScriptsCommand(char* args)
{
    ...
    if (*args!='a')
        sWorld.SendGMGlobalText("DB table `event_scripts` reloaded.");
...
bool ChatHandler::HandleReloadEventAITextsCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `creature_ai_texts` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadEventAISummonsCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `creature_ai_summons` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadEventAIScriptsCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `creature_ai_scripts` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadQuestEndScriptsCommand(char* args)
{
    ...
    if (*args != 'a')
        sWorld.SendGMGlobalText("DB table `quest_end_scripts` reloaded.");
...
bool ChatHandler::HandleReloadQuestStartScriptsCommand(char* args)
{
    ...
    if (*args != 'a')
        sWorld.SendGMGlobalText("DB table `quest_start_scripts` reloaded.");
...
bool ChatHandler::HandleReloadSpellScriptsCommand(char* args)
{
    ...
    if (*args != 'a')
        sWorld.SendGMGlobalText("DB table `spell_scripts` reloaded.");
...
bool ChatHandler::HandleReloadDbScriptStringCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `db_script_string` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadGameGraveyardZoneCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `game_graveyard_zone` reloaded.");
...
bool ChatHandler::HandleReloadGameTeleCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `game_tele` reloaded.");
...
bool ChatHandler::HandleReloadLocalesAchievementRewardCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `locales_achievement_reward` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLocalesCreatureCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `locales_creature` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLocalesGameobjectCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `locales_gameobject` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLocalesGossipMenuOptionCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `locales_gossip_menu_option` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLocalesItemCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `locales_item` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLocalesNpcTextCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `locales_npc_text` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLocalesPageTextCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `locales_page_text` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLocalesPointsOfInterestCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `locales_points_of_interest` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLocalesQuestCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `locales_quest` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadMailLevelRewardCommand(char* /*args*/)
{
    ...
    sWorld.SendGMGlobalText("DB table `mail_level_reward` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadAntiCheatCommand(char* /*arg*/)
{
    ...
    sWorld.SendGMGlobalText("Anticheat config reloaded.");
...
bool ChatHandler:: HandleListUnitEventsCommand(char* args)
{
    ...
    uint32 size = target->m_Events.GetSize();
    if (!size)
    {
        PSendSysMessage("Target %s has no pending events", target->GetGuidStr().c_str());
        return true;
    }

    time_t _time = time(NULL);
    EventList const & events = target->m_Events.GetEvents();
    uint32 i = 0;
    for (EventList::const_iterator itr = events.begin(); itr != events.end(); ++itr, ++i)
    {
        int32 scheduleOffset = int32(uint64(_time) - itr->second->m_addTime);
        int32 executeOffset = int32(itr->second->m_execTime - uint64(_time));

        PSendSysMessage("Event %u: %s, schedule offset: %i, execute time offest: %i, aborted: %u, is deletable: %u",
            i, itr->second->GetName(), scheduleOffset, executeOffset, itr->second->to_Abort, itr->second->IsDeletable());
    }
...
bool ChatHandler::HandleNpcInfoCommand(char* /*args*/)
{
    ...
    CreatureInfo const* baseInfo = sCreatureStorage.LookupEntry<CreatureInfo>(Entry);
    uint32 diff = 1;
...
bool ChatHandler::HandleNpcOwnerInfoCommand(char* /*args*/)
{
    ...
    PSendSysMessage("OwnerGuid: %s", target->GetOwnerGuid().GetString().c_str());
    PSendSysMessage("CreatorGuid: %s", target->GetCreatorGuid().GetString().c_str());
    PSendSysMessage("CharmerGuid: %s", target->GetCharmerGuid().GetString().c_str());
    PSendSysMessage("By Spell: %u", target->GetUInt32Value(UNIT_CREATED_BY_SPELL));

    return true;
}

bool ChatHandler::HandleNpcVehicleInfoCommand(char* args)
{
    Creature* target = getSelectedCreature();
    if(!target)
    {
    ...
    VehicleKit* vehicle = target->GetVehicleKit();
    if (!vehicle)
    {
        SendSysMessage("Target is not vehicle!");
        SetSentErrorMessage(true);
        return false;
    }

    PSendSysMessage("Target: %s, VehicleId: %u, Flags %X", target->GetGuidStr().c_str(), vehicle->GetVehicleId(), vehicle->GetVehicleInfo()->m_flags);
    for (uint8 i = 0; i < MAX_VEHICLE_SEAT; ++i)
    {
        const VehicleSeat* seat = vehicle->GetSeat(i);
        if (!seat)
            continue;

        const VehicleSeatEntry * entry = seat->seatInfo;
        if (!entry)
            continue;

        PSendSysMessage("Seat %u: Id: %u, Flags: %X, FlagsB: %X, Empty: %s, Passenger: %s", i, entry->m_ID, entry->m_flags, entry->m_flagsB, vehicle->HasEmptySeat(i) ? "true" : "false", seat->passenger ? seat->passenger->GetGuidStr().c_str() : "NULL");
    }
...
bool ChatHandler::HandleCharacterSetAccountCommand(char* args)
{
    if (!*args)
        return false;
    ...
    char* cNewAcc = ExtractArg(&args);
    if (!cNewAcc)
        return false;

    ObjectGuid target_guid = sObjectMgr.GetPlayerGuidByName(cName);
    ...
    uint32 uOldAcc = sObjectMgr.GetPlayerAccountIdByGUID(target_guid);
    /*if (!uOldAcc)
    {
        PSendSysMessage(LANG_ACCOUNT_FOR_PLAYER_NOT_FOUND, cName);
        SetSentErrorMessage(true);
        return false;
    }*/

    std::string sNewAcc = cNewAcc;
    uint32 uNewAcc = sAccountMgr.GetId(sNewAcc);
    if (!uNewAcc)
    {
        PSendSysMessage(LANG_TRANSFER_ACCOUNT_NOT_FOUND, sNewAcc.c_str());
        SetSentErrorMessage(true);
        return false;
    }

    std::string sOldAcc = "";
    sAccountMgr.GetName(uOldAcc, sOldAcc);

    std::string playerlink = playerLink(cName);
    if (uNewAcc == uOldAcc)
    {
        PSendSysMessage(LANG_TRANSFER_SAME_ACCOUNT, playerlink.c_str(), sNewAcc.c_str(), uNewAcc);
        SetSentErrorMessage(true);
        return false;
    }

    QueryResult* result = CharacterDatabase.PQuery("SELECT COUNT(*) FROM characters WHERE account = '%u'", uNewAcc);
    if (result)
    {
        ...
        if (count >= 10)
        {
            PSendSysMessage(LANG_TRANSFER_CHARACTER_OVERFLOW, playerlink.c_str(), sNewAcc.c_str(), uNewAcc);
            SetSentErrorMessage(true);
            return false;
        }
    }

    if (Player* player = sObjectMgr.GetPlayer(target_guid))
        player->GetSession()->KickPlayer();

    CharacterDatabase.PExecute("INSERT INTO character_account_log (guid, oldacc, newacc) VALUE ('%u', '%u', '%u')",
        target_guid.GetCounter(), uOldAcc, uNewAcc);

    CharacterDatabase.PExecute("UPDATE characters SET account = '%u' WHERE guid = '%u'",
        uNewAcc, target_guid.GetCounter());

    PSendSysMessage(LANG_TRANSFER_OK, playerlink.c_str(), sOldAcc.c_str(), uOldAcc, sNewAcc.c_str(), uNewAcc);
    ...
    for (Unit::SpellAuraHolderMap::const_iterator itr = uAuras.begin(); itr != uAuras.end(); ++itr)
    {
        ...
        for (int32 i = 0; i < MAX_EFFECT_INDEX; ++i)
        {
            ...
            if (m_session)
            {
                ...
                ss_name << " (s:" << itr->second->GetStackAmount() << "c:" << itr->second->GetAuraCharges() << ")";
    ...
    for (int i = 0; i < TOTAL_AURAS; ++i)
    {
        ...
        for (Unit::AuraList::const_iterator itr = uAuraList.begin(); itr != uAuraList.end(); ++itr)
        {
            ...
            if (m_session)
            {
                ...
                ss_name << " (s:" << (*itr)->GetStackAmount() << "c:" << (*itr)->GetHolder()->GetAuraCharges() << ")";
...
static bool HandleResetStatsOrLevelHelper(Player* player)
{
    ...
    if(!cEntry)
    {
        ERROR_LOG("Class %u not found in DBC (Wrong DBC files?)",player->getClass());
        return false;
    }
...
bool ChatHandler::HandleQuestCompleteCommand(char* args)
{
    ...
    for(uint8 i = 0; i < QUEST_OBJECTIVES_COUNT; ++i)
    {
        ...
        {
            if (CreatureInfo const* cInfo = sCreatureStorage.LookupEntry<CreatureInfo>(creature))
                for(uint16 z = 0; z < creaturecount; ++z)
...
bool ChatHandler::HandleBanCharacterAccCommand(char* args)
{
    return HandleBanHelper(BAN_CHARACTER_ACC, args);
}
...
bool ChatHandler::HandleBanHelper(BanMode mode, char* args)
{
    ...
    switch(sWorld.BanAccount(mode, nameOrIP, duration_secs, reason, m_session ? m_session->GetPlayerName() : "CONSOLE"))
    {
        case BAN_SUCCESS:
        {
            if (duration_secs > 0)
            ...
            std::stringstream sysmsgdota;
            argstr << who << " has just pwned " << nameOrIP << " due to " << reason << "! ";

            if (GM)
            {
                switch(++GM->m_GMscore)
                {
                    case 3: argstr << who << " is on a killing spree!"; break;
                    case 6: argstr << who << " is unstoppable!"; break;
                    case 9: argstr << who << " is dominating!"; break;
                    case 12: argstr << who << " is Wicked Sick!"; break;
                    case 15: argstr << who << " is GODLIKE!!!"; break;
                    case 18: argstr << who << " is BEYOND GODLIKE!!! SOMEBODY STOP HIM!!"; break;
                    default: break;
                }

                if (GM->m_GMtimekillscore + 7 * IN_MILLISECONDS >= WorldTimer::getMSTime())
                {
                    switch(++GM->m_GMkillscore)
                    {
                        case 1: sysmsgdota << who << " is Double punishment!"; break;
                        case 2: sysmsgdota << who << " is Triple punishment!"; break;
                        case 3: sysmsgdota << who << " is Ultra punishment!"; break;
                        case 4: sysmsgdota << who << " is R A M P A G E !"; break;
                        default: break;
                    }
                }
                else
                ...
                GM->m_GMtimekillscore = WorldTimer::getMSTime();
            }

            sWorld.SendWorldText(LANG_SYSTEMMESSAGE, argstr.str().c_str());

            if (GM && GM->m_GMkillscore > 0 && GM->m_GMkillscore < 5)
                sWorld.SendWorldText(LANG_SYSTEMMESSAGE, sysmsgdota.str().c_str());
        }
            break;
...
bool ChatHandler::HandleUnBanCharacterAccCommand(char* args)
{
    return HandleUnBanHelper(BAN_CHARACTER_ACC, args);
}
...
bool ChatHandler::HandleBanInfoAccountCommand(char* args)
{
    ...
    return HandleBanInfoAccHelper(accountid, account_name.c_str());
}
...
bool ChatHandler::HandleBanInfoCharacterCommand(char* args)
{
    ...
    std::string name;
    if (!sObjectMgr.GetPlayerNameByGUID(target_guid, name))
    {
        PSendSysMessage(LANG_BANINFO_NOCHARACTER);
        return true;
    }

    return HandleBanInfoCharHelper(target_guid.GetCounter(), name.c_str());
}

bool ChatHandler::HandleBanInfoCharacterAccCommand(char* args)
{
    Player* target;
    ObjectGuid target_guid;
    if (!ExtractPlayerTarget(&args, &target, &target_guid))
    ...
    return HandleBanInfoAccHelper(accountid, accountname.c_str());
}

bool ChatHandler::HandleBanInfoAccHelper(uint32 accountid, char const* accountname)
{
    ...
    PSendSysMessage(LANG_BANINFO_BANHISTORY_ACC, accountname);
    do
    {
        Field* fields = result->Fetch();
        ...
        PSendSysMessage(LANG_BANINFO_HISTORYENTRY_ACC,
...
bool ChatHandler::HandleBanInfoCharHelper(uint32 guid, char const* name)
{
    QueryResult *result = CharacterDatabase.PQuery("SELECT FROM_UNIXTIME(bandate), unbandate-bandate, active, unbandate, banreason, bannedby FROM character_banned WHERE guid = '%u' ORDER BY bandate ASC", guid);
    if (!result)
    {
        PSendSysMessage(LANG_BANINFO_NOCHARBAN, name);
        return true;
    }

    PSendSysMessage(LANG_BANINFO_BANHISTORY_CHAR, name);
    do
    {
        Field* fields = result->Fetch();
...
bool ChatHandler::HandleBanListCharacterCommand(char* args)
{
    ...
    QueryResult* result = CharacterDatabase.PQuery("SELECT guid, name FROM characters WHERE name "_LIKE_" "_CONCAT3_("'%%'","'%s'","'%%'"), filter.c_str());
    if (!result)
    {
        PSendSysMessage(LANG_BANLIST_NOCHARACTER2);
        return true;
    }

    return HandleBanListCharHelper(result);
}

bool ChatHandler::HandleBanListCharacterAccCommand(char* args)
{
    LoginDatabase.Execute("DELETE FROM ip_banned WHERE unbandate <= UNIX_TIMESTAMP() AND unbandate <> bandate");
    ...
    return HandleBanListAccHelper(result);
}
...
bool ChatHandler::HandleBanListAccHelper(QueryResult* result)
{
...
bool ChatHandler::HandleBanListCharHelper(QueryResult* result)
{
    PSendSysMessage(LANG_BANLIST_MATCHINGCHARS);
    ...
    if (m_session)
    {
        do
        {
            ...
            QueryResult* banresult = CharacterDatabase.PQuery("SELECT characters.name FROM characters, character_banned WHERE character_banned.guid = '%u' AND character_banned.guid=characters.guid", guid);
            if(banresult)
            {
                Field* fields2 = banresult->Fetch();
                PSendSysMessage("%s", fields2[0].GetString());
    ...
    else
    {
        ...
        do
        {
            ...
            QueryResult* banInfo = CharacterDatabase.PQuery("SELECT bandate, unbandate, bannedby, banreason FROM character_banned WHERE guid = %u ORDER BY unbandate", guid);
            if (banInfo)
            {
                Field* fields2 = banInfo->Fetch();
                do
                {
                    ...
                    {
                        PSendSysMessage("|%-15.15s|%02d-%02d-%02d %02d:%02d|   permanent  |%-15.15s|%-15.15s|",
                            name.c_str(), aTm_ban->tm_year % 100, aTm_ban->tm_mon + 1, aTm_ban->tm_mday, aTm_ban->tm_hour, aTm_ban->tm_min,
                            fields2[2].GetString(), fields2[3].GetString());
                    }
                    else
                    {
...
bool ChatHandler::HandleMovegensCommand(char* /*args*/)
{
    ...
    PSendSysMessage("Spline: %s", unit->movespline->Finalized() ? "FINALIZED" : "NOT FINALIZED");
    return true;
}
...
bool ChatHandler::HandleServerPLimitCommand(char *args)
{
    ...
    switch(allowedAccountType)
    {
        ...
        case SEC_CURATOR:       secName = "Curator";       break;
...
bool ChatHandler::HandleCharacterAddonSetCommand(char* args)
{
    if (!sWorld.getConfig(CONFIG_BOOL_CHARACTER_ADDON_ENABLED))
    {
        PSendSysMessage(LANG_CHARACTER_ADDON_DISABLED);
        SetSentErrorMessage(true);
        return false;
    }
    ...
    if (Player* pPlayer = sObjectMgr.GetPlayer(target_guid))
    {
        if (model > 0)
        {
            pPlayer->SetNativeDisplayId(model);
        ...
        if (scale > 0.0f)
        {
            ...
            pPlayer->SetFloatValue(OBJECT_FIELD_SCALE_X, scale);
            pPlayer->SetFloatValue(UNIT_FIELD_BOUNDINGRADIUS, DEFAULT_WORLD_OBJECT_SIZE);
        }
        else
            scale = 1.0f;
    }

    CharacterDatabase.PExecute("DELETE FROM `characters_addon` WHERE `guid` = '%u'", target_guid.GetCounter());
    CharacterDatabase.PExecute("INSERT INTO `characters_addon` (`guid`, `model`, `phase`, `scale`, `faction`, `comment`) VALUE ('%u', '%u', '%u', '%f', '%u', '%s')",
        target_guid.GetCounter(), model, phase, scale, faction, comment);

    std::string name;
    sObjectMgr.GetPlayerNameByGUID(target_guid, name);
    PSendSysMessage(LANG_CHARACTER_ADDON_ADD, name.c_str(), target_guid.GetCounter(), model, phase, scale, faction);

    return true;
}

bool ChatHandler::HandleCharacterAddonRemoveCommand(char* args)
{
    if (!sWorld.getConfig(CONFIG_BOOL_CHARACTER_ADDON_ENABLED))
    {
        PSendSysMessage(LANG_CHARACTER_ADDON_DISABLED);
    ...
    sObjectMgr.GetPlayerNameByGUID(target_guid, name);
    CharacterDatabase.PExecute("DELETE FROM `characters_addon` WHERE `guid` = '%u'", target_guid.GetCounter());
    PSendSysMessage(LANG_CHARACTER_ADDON_REMOVE, name.c_str(), target_guid.GetCounter());

    return true;
}

bool ChatHandler::HandleNpcSetVehicleIdCommand(char* args)
{
    uint16 vehicle_id = *args ? (uint16)atoi(args) : 0;

    Unit* target = getSelectedUnit();

    if (!target || target->GetTypeId() != TYPEID_UNIT || !target->GetObjectGuid().IsVehicle())
    {
        PSendSysMessage("No target or target is not vehicle.");
        SetSentErrorMessage(true);
        return false;
    }

    VehicleEntry const * entry = NULL;
    if (vehicle_id)
        entry = sVehicleStore.LookupEntry(vehicle_id);
    else
    {
        for (uint32 i = m_session->GetPlayer()->m_nextVehicleId; i < sVehicleStore.GetNumRows(); ++i)
        {
            entry = sVehicleStore.LookupEntry(i);
            if (entry)
                break;
        }
    }
    ...
    if (!entry)
    {
        PSendSysMessage("Wrong vehicle id %u.", vehicle_id);
        SetSentErrorMessage(true);
        return false;
    }

    m_session->GetPlayer()->m_nextVehicleId = entry->m_ID + 1;

    if (target->GetVehicleKit())
        target->RemoveVehicleKit();

    if (!target->CreateVehicleKit(entry->m_ID))
    {
        PSendSysMessage("Can't create vehicle kit id %u.", entry->m_ID);
        SetSentErrorMessage(true);
        return false;
    }
    ...
    PSendSysMessage("Vehicle id of %s set to %u.", target->GetGuidStr().c_str(), entry->m_ID);

    return true;
}

bool ChatHandler::HandleServerCleanGmPlayedTimeCommand(char* /*args*/)
{
    CharacterDatabase.Execute("DELETE FROM `gm_played_time`");

    {
        ...
        for (HashMapHolder<Player>::MapType::const_iterator itr = m.begin(); itr != m.end(); ++itr)
        {
            if (itr->second->GetSession()->GetSecurity() > SEC_PLAYER)
                itr->second->m_Played_time[PLAYED_TIME_GM] = 0;
        }
    }

    SendSysMessage("DB table `gm_played_time` erased.");
...
bool ChatHandler::HandleAchievementCriteriaUpdateCommand(char* args)
{
    Player* target;
    Unit* unit;
    uint32 type, value1, value2;
    bool withUnit;

    if (!ExtractUInt32(&args, type))
    {
        char* name = ExtractArg(&args);
        if (!ExtractPlayerTarget(&name, &target))
            return false;
    ...
    target->UpdateAchievementCriteria(AchievementCriteriaTypes(type), value1, value2, unit);
    PSendSysMessage("Updated criterias type %u for player %s with values %u %u and unit %s.",
        type, target->GetName(), value1, value2, unit ? unit->GetName() : "NULL");

    return true;
}

bool ChatHandler::HandleWGPromoteCommand(char* args)
{
    if (!*args)
        return false;
...
bool ChatHandler::HandleWGTimerCommand(char* args)
{
    if (!*args)
        return false;
    ...
    opvp->SetTimer(value);
    sWorld.SendUpdateWintergraspTimerWorldState(opvp);
...
bool ChatHandler::HandleWGStatusCommand(char* args)
{
    ...
    std::list<std::string> debugInfo = opvp->GetStatusDebugInfo();
    for (std::list<std::string>::iterator itr = debugInfo.begin(); itr != debugInfo.end(); ++itr)
...
bool ChatHandler::HandleWGPlayerStatusCommand(char* args)
{
    ...
    std::list<std::string> debugInfo = opvp->GetPlayerDebugInfo(target);
    for (std::list<std::string>::iterator itr = debugInfo.begin(); itr != debugInfo.end(); ++itr)
        PSendSysMessage(itr->c_str());
...
bool ChatHandler::HandleWGTowerCommand(char* args)
{
    ...
    std::list<std::string> debugInfo = opvp->GetTowerDebugInfo();
    for (std::list<std::string>::iterator itr = debugInfo.begin(); itr != debugInfo.end(); ++itr)
        PSendSysMessage(itr->c_str());
...
bool ChatHandler::HandleWGWallCommand(char* args)
{
    ...
    std::list<std::string> debugInfo = opvp->GetWallDebugInfo();
    for (std::list<std::string>::iterator itr = debugInfo.begin(); itr != debugInfo.end(); ++itr)
        PSendSysMessage(itr->c_str());
...
bool ChatHandler::HandleMapManagerInfoCommand(char* args)
{
    PSendSysMessage("Map Manager Update Diff: %u ms, max: %u ms", sWorld.m_mapManagerUpdateTime, sWorld.m_mapManagerMaxUpdateTime);

    for (std::map<uint32, uint32>::iterator itr = sMapMgr.m_LastMapUpdateTimes.begin(); itr != sMapMgr.m_LastMapUpdateTimes.end(); ++itr)
    {
        uint32 max = 0;
        if (sMapMgr.m_MaxMapUpdateTimes.find(itr->first) != sMapMgr.m_LastMapUpdateTimes.end())
            max = sMapMgr.m_MaxMapUpdateTimes[itr->first];

        PSendSysMessage("%u: current %u ms max %u ms", itr->first, itr->second, max);
    }

    return true;
}

bool ChatHandler::HandleClearMapManagerInfoCommand(char* args)
{
    sMapMgr.m_LastMapUpdateTimes.clear();
    sMapMgr.m_MaxMapUpdateTimes.clear();

    sWorld.m_mapManagerUpdateTime = 0;
    sWorld.m_mapManagerMaxUpdateTime = 0;
