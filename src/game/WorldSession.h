...
enum AccountPremiumRateType
{
    PREMIUM_RATE_XP     = 0,
    PREMIUM_RATE_MONEY  = 1,
    PREMIUM_RATE_HONOR  = 2
};
...
class MANGOS_DLL_SPEC WorldSession
{
    ...
    public:
        ...
        bool IsPremiumActive() { return m_isPremium && m_PremiumTimeEnd > time(NULL); }
        AccountPremiumType GetPremiumType() { return m_premiumType; }
        AccountPremiumRateType GetPremiumRateType() { return m_premiumRateType; }
    ...
    public:                                                 // opcodes handlers
        ...
        void SendPetSlotUpdated(uint32 petNumber, int32 srcSlot, int32 dstSlot, int32 unk);
