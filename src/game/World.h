...
enum WorldTimers
{
    ...
    WUPDATE_AHBOT       = 7,
    WUPDATE_UNBAN_CHAR  = 8,
    WUPDATE_GUILD_SAVE  = 9,
    WUPDATE_FAKE_ONLINE = 10,
    WUPDATE_COUNT       = 11
};
...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_CHNCNT,
    CONFIG_UINT32_CHNID,
    CONFIG_UINT32_RATE_BUY_PRICE,
    CONFIG_UINT32_RATE_SELL_PRICE,
    CONFIG_UINT32_RATE_REPAIR_PRICE,
    CONFIG_UINT32_CUSTOM_NPC_TELEPORT_GOLD_COST,
    CONFIG_UINT32_HAPPYTIME1_START_HOUR,
    CONFIG_UINT32_HAPPYTIME1_DURATION,
    CONFIG_UINT32_HAPPYTIME1_WEEK_DAY,
    CONFIG_UINT32_PREMIUM_TELEPORT_COOLDOWN_MINUTES,
    ...
    CONFIG_UINT32_ITEM_SOULBOUND_TRADE_TIME,
    CONFIG_UINT32_ITEM_REFUND_TIME,
    CONFIG_UINT32_KICK_DELAY,
    CONFIG_UINT32_FUN_REROLL_COST_TYPE_CUSTOMIZE,
    CONFIG_UINT32_FUN_REROLL_COST_TYPE_FACTION,
    CONFIG_UINT32_FUN_REROLL_COST_TYPE_RACE,
    CONFIG_UINT32_FUN_REROLL_COST_CUSTOMIZE,
    CONFIG_UINT32_FUN_REROLL_COST_FACTION,
    CONFIG_UINT32_FUN_REROLL_COST_RACE,
    CONFIG_UINT32_FUN_RATE_A1,
    CONFIG_UINT32_FUN_RATE_A2,
    CONFIG_UINT32_FUN_RATE_A3,
    CONFIG_UINT32_FUN_RATE_A4,
    CONFIG_UINT32_FUN_BRACKET_A1,
    CONFIG_UINT32_FUN_BRACKET_A2,
    CONFIG_UINT32_FUN_BRACKET_A3,
    CONFIG_UINT32_FUN_BRACKET_A4,
    CONFIG_UINT32_AUTOBROADCAST_TIMER,
    CONFIG_UINT32_AUTOBROADCAST_CENTER,
    CONFIG_UINT32_WINTERGRASP_COOLDOWN_DURATION,
    ...
    CONFIG_UINT32_PLAYED_TIME_BEFORE_TRADE,
    CONFIG_UINT32_PLAYED_TIME_BEFORE_LFG_SPEAK,
    ...
    CONFIG_UINT32_FAKE_ONLINE_UPDATE_INTERVAL,
    CONFIG_UINT32_FAKE_ONLINE_MIN_PLAYERS,
    CONFIG_UINT32_FAKE_ONLINE_MAX_PLAYERS,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_HAPPYTIME1_MODIFIER_DROP_ITEM,
    CONFIG_FLOAT_HAPPYTIME1_MODIFIER_DROP_MONEY,
    CONFIG_FLOAT_HAPPYTIME1_MODIFIER_XP,
    CONFIG_FLOAT_HAPPYTIME1_MODIFIER_HONOR,
    CONFIG_FLOAT_HAPPYTIME1_MODIFIER_REPUTATION,
    CONFIG_FLOAT_PREMIUM_MODIFIER_RATE_DROP_MONEY,
    CONFIG_FLOAT_PREMIUM_MODIFIER_RATE_HONOR,
    CONFIG_FLOAT_PREMIUM_MODIFIER_RATE_XP,
    CONFIG_FLOAT_MIN_ANTIAFK_DISTANCE,
    CONFIG_FLOAT_RATE_RAF_XP,
    CONFIG_FLOAT_RATE_RAF_LEVELPERLEVEL,
    CONFIG_FLOAT_RATE_GUILD_XP_MODIFIER,
    CONFIG_FLOAT_FAKE_ONLINE_COUNT_FRACTION,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_CHARACTER_ADDON_ENABLED,
    CONFIG_BOOL_HAPPYTIME1_ENABLED,
    CONFIG_BOOL_ANTICHEAT_ENABLE,
    CONFIG_BOOL_ANTICHEAT_WARDEN,
    CONFIG_BOOL_CHARACTER_VISUALS_OVERRIDE,
    CONFIG_BOOL_FUN_ENABLED,
    CONFIG_BOOL_FUN_DUEL_RESET_COOLDOWNS,
    CONFIG_BOOL_FUN_DUEL_RESET_STATS,
    ...
    CONFIG_BOOL_LOG_AUCTION,
    CONFIG_BOOL_SPECTATING_ENABLED,
    CONFIG_BOOL_GCD_ANTICHEAT_ENABLED,
    CONFIG_BOOL_AUTOBROADCAST_ENABLED,
    CONFIG_BOOL_ALLOW_HONOR_KILLS_TITLES,
    CONFIG_BOOL_GUILD_LEVELING_ENABLED,
    CONFIG_BOOL_FAKE_ONLINE_ENABLED,
...
class World
{
    public:
        ...
        uint32 GetMaxUpdateTime() const { return m_maxUpdateTime; }
        ...
        void SendGMGlobalText(AccountTypes sec, int32 string_id, ...);
        void SendGMGlobalText(const char* str, AccountTypes sec = SEC_MODERATOR);
        void SendTeamText(Team team, int32 string_id, ...);
        ...
        uint32 ShutdownTimer() const { return m_ShutdownTimer; }
        ...
        // Amaru: anticheat enable flag
        inline uint32 GetAnticheatBuggedValueSpd()     {return m_AnticheatBuggedValueSpd;}
        inline uint32 GetAnticheatBuggedValueAP()      {return m_AnticheatBuggedValueAP;} 
        inline uint32 GetAnticheatBuggedValueHealth()  {return m_AnticheatBuggedValueHealth;}
        inline uint32 GetAnticheatBuggedValueMana()    {return m_AnticheatBuggedValueMana;}
        ...
        bool GetWorldState(uint32 index, uint32& value) const;
        void LoadWorldStates();

        FunSettings funSettings;

        uint32 m_mapManagerUpdateTime;
        uint32 m_mapManagerMaxUpdateTime;
    ...
    protected:
        ...
        void GetTicketsUpdate();
        void ApplyEvent1();
        void RemoveEvent1();
        void InitEvent1Start();
    ...
    private:
        ...
        //Amaru: anticheat enable flag
        uint32 m_AnticheatBuggedValueSpd;
        uint32 m_AnticheatBuggedValueAP;
        uint32 m_AnticheatBuggedValueHealth;
        uint32 m_AnticheatBuggedValueMana;
        ...
        time_t m_NextGiftUpdate;
        time_t m_NextTicketsUpdate;
        time_t m_NextGetConsoleCommands;
        time_t m_NextEvent1Start;
        time_t m_NextEvent1End;
        ...
        // Autobroadcast
        std::map<uint32, std::string> m_autoBroadcasts;
        uint32 m_broadcastNext;
