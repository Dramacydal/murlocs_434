...
class MANGOS_DLL_SPEC Creature : public Unit
{
    ...
    public:
        ...
        uint32 GetShieldBlockDamageValue(bool capped) const override         // dunno mob block value
        {
...
class AssistDelayEvent : public BasicEvent
{
    public:
        ...
        char const * GetName() const override { return "AssistDelayEvent"; }
...
class ForcedDespawnDelayEvent : public BasicEvent
{
    public:
        ...
        char const * GetName() const override { return "ForcedDespawnDelayEvent"; }
