...
enum Opcodes
{
    ...
    SMSG_BATTLEFIELD_MANAGER_ENTRY_INVITE                 = 0x34B3, // 4.3.4 15595
    CMSG_BATTLEFIELD_MANAGER_ENTRY_INVITE_RESPONSE        = 0x05A3, // 4.3.4 15595
    SMSG_BATTLEFIELD_MANAGER_ENTERING                     = 0x5CA0, // 4.3.4 15595
    SMSG_BATTLEFIELD_MANAGER_QUEUE_INVITE                 = 0x15A6, // 4.3.4 15595
    CMSG_BATTLEFIELD_MANAGER_QUEUE_INVITE_RESPONSE        = 0x0413, // 4.3.4 15595
    CMSG_BATTLEFIELD_MANAGER_QUEUE_REQUEST                = 0x710C, // 4.3.4 15595
    SMSG_BATTLEFIELD_MANAGER_QUEUE_REQUEST_RESPONSE       = 0x79B6, // 4.3.4 15595
    SMSG_BATTLEFIELD_MANAGER_EJECT_PENDING                = 0x14E6,
    SMSG_BATTLEFIELD_MANAGER_EJECTED                      = 0x7DB7, // 4.3.4 15595
    CMSG_BATTLEFIELD_MANAGER_EXIT_REQUEST                 = 0x2490, // 4.3.4 15595
