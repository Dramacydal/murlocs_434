...
enum
{
    SPELL_CLICK_FLAG_PLAYER_AS_CASTER           = 0x01,
    SPELL_CLICK_FLAG_PLAYER_AS_TARGET           = 0x02,
    SPELL_CLICK_FLAG_OWNER_AS_AFFECTIVE_CASTER  = 0x04,
    SPELL_CLICK_FLAG_FORCE_NOT_TRIGGERED        = 0x08,
    SPELL_CLICK_FLAG_DESPAWN_AFTER_USE          = 0x80,
};
...
typedef std::vector<RFCData> RFCDataList;
...
enum ConditionSource                                        // From where was the condition called?
{
    ...
    CONDITION_FROM_PHASEMGR         = 7,                    // called from phase manager
};
...
class ObjectMgr
{
    ...
    public:
        ...
        void LoadFunItemAddon(ItemPrototype const* proto);
        ...
        uint32 GenerateArenaGameId() { return m_ArenaGameIds.Generate(); }
        ...
        RFCDataList&    GetRFCAchievementDataList() { return m_RFCAchievementDataList; }
        RFCDataList&    GetRFCItemDataList() { return m_RFCItemDataList; }
        RFCDataList&    GetRFCReputationDataList() { return m_RFCReputationDataList; }
        RFCDataList&    GetRFCSpellDataList() { return m_RFCSpellDataList; }
        RFCDataList&    GetRFCTitlesDataList() { return m_RFCTitlesDataList; }

        void LoadAllowedPets();
        std::set<uint32>& GetAllowedPets() { return m_allowedPets; }
    ...
    protected:
        ...
        RFCDataList         m_RFCAchievementDataList;
        RFCDataList         m_RFCItemDataList;
        RFCDataList         m_RFCReputationDataList;
        RFCDataList         m_RFCSpellDataList;
        RFCDataList         m_RFCTitlesDataList;
