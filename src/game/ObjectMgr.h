...
enum
{
    SPELL_CLICK_FLAG_PLAYER_AS_CASTER           = 0x1,
    SPELL_CLICK_FLAG_PLAYER_AS_TARGET           = 0x2,
    SPELL_CLICK_FLAG_OWNER_AS_AFFECTIVE_CASTER  = 0x4,
    SPELL_CLICK_FLAG_FORCE_NOT_TRIGGERED        = 0x8,
};
...
enum ConditionSource                                        // From where was the condition called?
{
    ...
    CONDITION_FROM_PHASEMGR         = 6,                    // called from phase manager
};
