...
class BGQueueInviteEvent : public BasicEvent
{
    public:
        ...
        char const * GetName() const override { return "BGQueueInviteEvent"; }
    private:
...
class BGQueueRemoveEvent : public BasicEvent
{
    public:
        ...
        char const * GetName() const override { return "BGQueueRemoveEvent"; }
...
class BattleGroundMgr
{
    public:
        ...
        BattleGround* CreateNewBattleGround(BattleGroundTypeId bgTypeId, PvPDifficultyEntry const* bracketEntry, ArenaType arenaType, bool isRated, BattleGroundQueue::SelectionPool* selectionPool = NULL);
