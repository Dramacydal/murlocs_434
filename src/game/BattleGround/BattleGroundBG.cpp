...
void BattleGroundBG::FillInitialWorldStates(WorldPacket& data, uint32& count)
{
    ...
    FillInitialWorldState(data, count, BG_BG_OP_RESOURCES_ALLY,     m_TeamScores[TEAM_INDEX_ALLIANCE]);
    FillInitialWorldState(data, count, BG_BG_OP_RESOURCES_HORDE,    m_TeamScores[TEAM_INDEX_HORDE]);
