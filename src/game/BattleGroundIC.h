...
{
    IC_WS_ALLIANCE_REINFORC_ON  = 4221,
    IC_WS_HORDE_RENFORC_ON      = 4222,
    IC_WS_ALLIANCE_REINFORC     = 4226,
    IC_WS_HORDE_REINFORC        = 4227,
    ...
    TEAM_INDEX_ALLIANCE_KEEP_UNCONTROLLED = 4341,
    TEAM_INDEX_ALLIANCE_KEEP_CONFLICT_A   = 4342,
    TEAM_INDEX_ALLIANCE_KEEP_CONFLICT_H   = 4343,
    TEAM_INDEX_ALLIANCE_KEEP_CONTROLLED_A = 4339,
    TEAM_INDEX_ALLIANCE_KEEP_CONTROLLED_H = 4340,

    TEAM_INDEX_HORDE_KEEP_UNCONTROLLED    = 4346,
    TEAM_INDEX_HORDE_KEEP_CONFLICT_A      = 4347,
    TEAM_INDEX_HORDE_KEEP_CONFLICT_H      = 4348,
    TEAM_INDEX_HORDE_KEEP_CONTROLLED_A    = 4344,
    TEAM_INDEX_HORDE_KEEP_CONTROLLED_H    = 4345*/
};
...
const uint32 BG_IC_Gate_WS[BG_IC_GATE_MAX][2] =
{
...
const float BG_IC_GATELOCS[6][4] =
{
...
const float BG_IC_Trans_Offsets[2][4] = 
{
    // Alliance
    { -13.055938f, 0.039919f, 24.363810f, 2.828681f },
    // Horde
    { 7.471371f, 0.438853f, 34.432571f, 3.145255f },
...
class BattleGroundIC : public BattleGround
{
    ...
    public:
        ...
        bool hasAllNodes(TeamIndex team);
