...
enum MangosStrings
{
    ...
    LANG_BANINFO_BANHISTORY_ACC         = 417,
    LANG_BANINFO_HISTORYENTRY_ACC       = 418,
...
//                                      = 783, not used
    ...
    LANG_BANINFO_NOCHARBAN              = 11001,
    LANG_BANINFO_BANHISTORY_CHAR        = 11002,
    LANG_VEHICLE_ZONE_EXPIRE            = 11003,
    LANG_CHARACTER_ADDON_ADD            = 11004,
    LANG_CHARACTER_ADDON_REMOVE         = 11005,
    LANG_CHARACTER_ADDON_DISABLED       = 11006,

    LANG_DKQ_COMMAND_NOT_DK             = 11007,
    LANG_DKQ_COMMAND_QUEST_LIST         = 11008,
    LANG_DKQ_COMMAND_QUEST              = 11009,
    LANG_DKQ_COMMAND_ALL_COMPLETED      = 11010,

    LANG_RAID_BOSS_CHEAT_1              = 11011,
    LANG_RAID_BOSS_CHEAT_2              = 11012,

    LANG_ANTICHEAT_DETECT               = 11013,

    LANG_CRASHREPORTER                  = 11014,

    LANG_ONLY_PREMIUM                   = 11015,
    LANG_ONLY_PREMIUM_EXTENDED          = 11016,

    LANG_RACE_HUMAN                     = 11017,
    LANG_RACE_ORC                       = 11018,
    LANG_RACE_DWARF                     = 11019,
    LANG_RACE_NIGHTELF                  = 11020,
    LANG_RACE_UNDEAD                    = 11021,
    LANG_RACE_TAUREN                    = 11022,
    LANG_RACE_GNOME                     = 11023,
    LANG_RACE_TROLL                     = 11024,
    LANG_RACE_BLOODELF                  = 11025,
    LANG_RACE_DRAENEI                   = 11026,

    LANG_CLASS_WARRIOR                  = 11027,
    LANG_CLASS_PALADIN                  = 11028,
    LANG_CLASS_HUNTER                   = 11029,
    LANG_CLASS_ROGUE                    = 11030,
    LANG_CLASS_PRIEST                   = 11031,
    LANG_CLASS_DEATH_KNIGHT             = 11032,
    LANG_CLASS_SHAMAN                   = 11033,
    LANG_CLASS_MAGE                     = 11034,
    LANG_CLASS_WARLOCK                  = 11035,
    LANG_CLASS_DRUID                    = 11036,

    LANG_GENDER_MALE                    = 11037,
    LANG_GENDER_FEMALE                  = 11038,

    LANG_GINFO                          = 11039,
    LANG_GINFO_MEMBER                   = 11040,
    LANG_GINFO_LEADER                   = 11041,
    LANG_GINFO_ON_TAXI                  = 11042,

    LANG_BANLIST_MATCHINGCHARS          = 11043,
    LANG_BANLIST_CHARACTERS             = 11044,
    LANG_BANLIST_CHARACTERS_HEADER      = 11045,
    LANG_BANLIST_NOCHARACTER2           = 11046,

    LANG_TRANSFER_ACCOUNT_NOT_FOUND     = 11047,
    LANG_TRANSFER_SAME_ACCOUNT          = 11048,
    LANG_TRANSFER_CHARACTER_OVERFLOW    = 11049,
    LANG_TRANSFER_OK                    = 11050,

    LANG_CHANGERACE_PLAYER              = 11051,
    LANG_CHANGERACE_PLAYER_GUID         = 11052,
    LANG_CHANGEFACTION_PLAYER           = 11053,
    LANG_CHANGEFACTION_PLAYER_GUID      = 11054,

    LANG_CONVERTTITLES_PLAYER           = 11055,
    LANG_CONVERTTITLES_PLAYER_GUID      = 11056,

    LANG_SETVIEW_DONE                   = 11057,
    LANG_SETVIEW_RESET                  = 11058,

    LANG_COMMAND_FRIEND                 = 11059,
    LANG_COMMAND_FRIEND_ERROR           = 11060,

    LANG_FUN_TELEPORT_DISABLED          = 11061,
    LANG_FUN_INSTANCES_DISABLED         = 11062,

    LANG_YOU_WILL_BE_KICKED_IN          = 11063,

    LANG_NOT_ENOUGH_HONOR               = 11064,
    LANG_NOT_ENOUGH_AP                  = 11065,

    LANG_CANT_DO_THAT_WHILE_SPECTATING  = 11066,
    LANG_CANT_SPECTATE_WHILE_DEAD       = 11067,
    LANG_CANT_SPECTATE_HERE             = 11068,
    LANG_ALREADY_SPECTATING             = 11069,
    LANG_NOT_SPECTATING                 = 11070,
    LANG_CANT_SPECTATE_SPECTATOR        = 11071,
    LANG_SPECTATING_ALLOWED             = 11072,
    LANG_SPECTATING_FORBIDDEN           = 11073,
    LANG_SPECTATING_FORBIDDEN_PLAYER    = 11074,
    LANG_SPECTATING_DISABLED            = 11075,
    LANG_TARGET_NOT_IN_ARENA            = 11076,
    LANG_CANT_SPECTATE_WHILE_IN_QUEUE   = 11077,

    // Wintergrasp
    LANG_WG_ABOUT_TO_BEGIN              = 11078,
    LANG_WG_BATTLE_BEGIN                = 11079,
    LANG_WG_ALLIANCE_DEFENDED           = 11080,
    LANG_WG_ALLIANCE_CAPTURED           = 11081,
    LANG_WG_HORDE_DEFENDED              = 11082,
    LANG_WG_HORDE_CAPTURED              = 11083,
    LANG_WG_BROKEN_TEMPLE_ATTACKED_A    = 11084,
    LANG_WG_BROKEN_TEMPLE_CAPTURED_A    = 11085,
    LANG_WG_BROKEN_TEMPLE_ATTACKED_H    = 11086,
    LANG_WG_BROKEN_TEMPLE_CAPTURED_H    = 11087,
    LANG_WG_WESTPARK_ATTACKED_A         = 11088,
    LANG_WG_WESTPARK_CAPTURED_A         = 11089,
    LANG_WG_WESTPARK_ATTACKED_H         = 11090,
    LANG_WG_WESTPARK_CAPTURED_H         = 11091,
    LANG_WG_EASTPARK_ATTACKED_A         = 11092,
    LANG_WG_EASTPARK_CAPTURED_A         = 11093,
    LANG_WG_EASTPARK_ATTACKED_H         = 11094,
    LANG_WG_EASTPARK_CAPTURED_H         = 11095,
    LANG_WG_SUNKEN_RING_ATTACKED_A      = 11096,
    LANG_WG_SUNKEN_RING_CAPTURED_A      = 11097,
    LANG_WG_SUNKEN_RING_ATTACKED_H      = 11098,
    LANG_WG_SUNKEN_RING_CAPTURED_H      = 11099,
    LANG_WG_WESTERN_TOWER_DAMAGED       = 11100,
    LANG_WG_WESTERN_TOWER_DESTROYED     = 11101,
    LANG_WG_SOUTHERN_TOWER_DAMAGED      = 11102,
    LANG_WG_SOUTHERN_TOWER_DESTROYED    = 11103,
    LANG_WG_EASTERN_TOWER_DAMAGED       = 11104,
    LANG_WG_EASTERN_TOWER_DESTROYED     = 11105,
    LANG_WG_NW_TOWER_DAMAGED            = 11106,
    LANG_WG_NW_TOWER_DESTROYED          = 11107,
    LANG_WG_NE_TOWER_DAMAGED            = 11108,
    LANG_WG_NE_TOWER_DESTROYED          = 11109,
    LANG_WG_SW_TOWER_DAMAGED            = 11110,
    LANG_WG_SW_TOWER_DESTROYED          = 11111,
    LANG_WG_SE_TOWER_DAMAGED            = 11112,
    LANG_WG_SE_TOWER_DESTROYED          = 11113,
    LANG_WG_REACHED_RANK_1              = 11114,
    LANG_WG_REACHED_RANK_2              = 11115,

    LANG_WG_DESTROYED_FIRST_A           = 11116,
    LANG_WG_DESTROYED_SECOND_A          = 11117,
    LANG_WG_DESTROYED_THIRD_A           = 11118,
    LANG_WG_DESTROYED_FIRST_H           = 11119,
    LANG_WG_DESTROYED_SECOND_H          = 11120,
    LANG_WG_DESTROYED_THIRD_H           = 11121,

    LANG_PREFERED_BG_WRONG              = 11122,
    LANG_PREFERED_BG_SET_RB             = 11123,
    LANG_PREFERED_BG_SET_WS             = 11124,
    LANG_PREFERED_BG_SET_AB             = 11125,
    LANG_PREFERED_BG_SET_EY             = 11126,
    LANG_PREFERED_BG_SET_AV             = 11127,
    LANG_PREFERED_BG_SET_SA             = 11128,
    LANG_PREFERED_BG_SET_IC             = 11129,

    LANG_NOT_ON_VEHICLE                 = 11130,
    LANG_VEHICLE_DISMOUNTED             = 11131,

    LANG_WRONG_ARENA_TYPE               = 11132,
    ...
    //LANG_LFG_PLAYER_INFO                = 11176,
    //LANG_LFG_GROUP_INFO                 = 11177,
    //LANG_LFG_NOT_IN_GROUP               = 11178,
    //LANG_LFG_CLEAN                      = 11179,
    //LANG_LFG_OPTIONS                    = 11180,
    //LANG_LFG_OPTIONS_CHANGED            = 11181,
    LANG_LFG_STATE_NONE                 = 11182,
    LANG_LFG_STATE_ROLECHECK            = 11183,
    LANG_LFG_STATE_QUEUED               = 11184,
    LANG_LFG_STATE_PROPOSAL             = 11185,
    LANG_LFG_STATE_BOOT                 = 11186,
    LANG_LFG_STATE_DUNGEON              = 11187,
    LANG_LFG_STATE_FINISHED_DUNGEON     = 11188,
    LANG_LFG_STATE_RAIDBROWSER          = 11189,
    LANG_LFG_ROLE_TANK                  = 11190,
    LANG_LFG_ROLE_HEALER                = 11191,
    LANG_LFG_ROLE_DAMAGE                = 11192,
    LANG_LFG_ROLE_LEADER                = 11193,
    LANG_LFG_ROLE_NONE                  = 11194,
    LANG_LFG_ERROR                      = 11195,
    ...
    LANG_BG_SA_START_TWO_MINUTE_SECOND_ROUND        = 20004,
    LANG_BG_SA_START_ONE_MINUTE_SECOND_ROUND        = 20005,
    LANG_BG_SA_START_HALF_MINUTE_SECOND_ROUND       = 20006,

    LANG_BG_SA_GATE_ROOM_ANCIENT_SHRINE_ATTACKED    = 20007,
    LANG_BG_SA_GATE_GREEN_EMERALD_ATTACKED          = 20008,
    LANG_BG_SA_GATE_BLUE_SAPHIRE_ATTACKED           = 20009,
    LANG_BG_SA_GATE_PURPLE_AMETHYST_ATTACKED        = 20010,
    LANG_BG_SA_GATE_RED_SUN_ATTACKED                = 20011,
    LANG_BG_SA_GATE_YELLOW_MOON_ATTACKED            = 20012,

    LANG_BG_SA_HORDE_EAST_CONQUESTED                = 20013,
    LANG_BG_SA_HORDE_WEST_CONQUESTED                = 20014,
    LANG_BG_SA_HORDE_SOUTH_CONQUESTED               = 20015,
    LANG_BG_SA_ALLIANCE_EAST_CONQUESTED             = 20016,
    LANG_BG_SA_ALLIANCE_WEST_CONQUESTED             = 20017,
    LANG_BG_SA_ALLIANCE_SOUTH_CONQUESTED            = 20018,

    LANG_BG_SA_GATE_ROOM_ANCIENT_SHRINE_DESTROYED   = 20019,
    LANG_BG_SA_GATE_GREEN_EMERALD_DESTROYED         = 20020,
    LANG_BG_SA_GATE_BLUE_SAPHIRE_DESTROYED          = 20021,
    LANG_BG_SA_GATE_PURPLE_AMETHYST_DESTROYED       = 20022,
    LANG_BG_SA_GATE_RED_SUN_DESTROYED               = 20023,
    LANG_BG_SA_GATE_YELLOW_MOON_DESTROYED           = 20024,

    LANG_BG_SA_TITAN_PORTAL_CAPTURED_ALLIANCE       = 20025,
    LANG_BG_SA_TITAN_PORTAL_CAPTURED_HORDE          = 20026,

    LANG_BG_SA_ROUND_ONE_FINISHED                   = 20027,
    LANG_BG_SA_ROUND_TWO_FINISHED                   = 20028,

    LANG_BG_SA_YELL_SPARKLIGHT                      = 20029,
    LANG_BG_SA_YELL_RIGSPARK                        = 20030,

    LANG_DALARAN_SEAL_THROW                         = 20100,
    LANG_DALARAN_SEAL_UP                            = 20101,
    LANG_DALARAN_SEAL_DOWN                          = 20102,

    // Isle of Conquest
    LANG_BG_IC_START_TWO_MINUTES                    = 20060,
    LANG_BG_IC_START_ONE_MINUTE                     = 20061,
    LANG_BG_IC_START_HALF_MINUTE                    = 20062,
    LANG_BG_IC_HAS_BEGUN                            = 20063,
    LANG_BG_IC_ALLIANCE_KEEP                        = 20064,
    LANG_BG_IC_HORDE_KEEP                           = 20065,
    LANG_BG_IC_ALLIANCE_WINS                        = 20066,
    LANG_BG_IC_HORDE_WINS                           = 20067,
    LANG_BG_IC_A_WEST_GATE_DESTROYED                = 20068,
    LANG_BG_IC_A_EAST_GATE_DESTROYED                = 20069,
    LANG_BG_IC_A_FRONT_GATE_DESTROYED               = 20070,
    LANG_BG_IC_H_WEST_GATE_DESTROYED                = 20071,
    LANG_BG_IC_H_EAST_GATE_DESTROYED                = 20072,
    LANG_BG_IC_H_FRONT_GATE_DESTROYED               = 20073,
    LANG_BG_IC_NODE_ASSAULTED                       = 20074,
    LANG_BG_IC_NODE_DEFENDED                        = 20075,
    LANG_BG_IC_NODE_CLAIMED                         = 20076,
    LANG_BG_IC_NODE_TAKEN                           = 20077,
    LANG_BG_IC_NODE_WORKSHOP                        = 20078,
    LANG_BG_IC_NODE_DOCKS                           = 20079,
    LANG_BG_IC_NODE_REFINERY                        = 20080,
