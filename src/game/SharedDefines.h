...
enum SpellAttributesEx
{
    ...
    SPELL_ATTR_EX_CANT_REFLECTED               = 0x00000008,// 3
...
enum SpellAttributesEx3
{
    ...
    SPELL_ATTR_EX3_TARGET_ONLY_PLAYER          = 0x00000100,            // 8
...
enum SpellAttributesEx4
{
    ...
    SPELL_ATTR_EX4_FIXED_DAMAGE                = 0x00000100,            // 8 has fixed damage
...
enum SpellAttributesEx7
{
    ...
    SPELL_ATTR_EX7_UNK3                        = 0x00000008,            // 3  Only 43574 test spell.
    SPELL_ATTR_EX7_UNK4                        = 0x00000010,            // 4  Only 66109 test spell.
    SPELL_ATTR_EX7_TOTEM_SPELL                 = 0x00000020,            // 5  Only Shaman player totems.
...
enum Targets
{
    ...
    TARGET_CHANNEL                     = 11,                // used by spell 4 'Word of Recall Other'
