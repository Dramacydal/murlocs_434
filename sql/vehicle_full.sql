...
ALTER TABLE creature_template CHANGE COLUMN unk16 health_mod float;
ALTER TABLE creature_template CHANGE COLUMN unk17 power_mod float;
...
(32640, 32642, 1, 1, 'Traveler Mammoth (H) - Vendor'),
(32640, 32641, 2, 1, 'Traveler Mammoth (H) - Vendor & Repairer'),
(32633, 32638, 1, 1, 'Traveler Mammoth (A) - Vendor'),
(32633, 32639, 2, 1, 'Traveler Mammoth (A) - Vendor & Repairer'),
(33669, 33666, 0, 0, 'Demolisher Engineer Blastwrench'),
(29555, 29556, 0, 0, 'Goblin Sapper'),
(28018, 28006, 0, 1, 'Thiassi the Light Bringer'),
(28054, 28053, 0, 1, 'Lucky Wilhelm - Apple'),
(28614, 28616, 0, 1, 'Scarlet Gryphon Rider'),
(36476, 36477, 0, 1, 'Krick and Ick'),
(36661, 36658, 0, 0, 'Scourgelord Tyrannus and Rimefang'),
(29433, 29440, 0, 0, 'Goblin Sapper in K3');

-- IoC
DELETE FROM `vehicle_accessory` WHERE entry IN (35069, 35433, 34776, 35431);
...
(35433, 36357, 7, 1, 'Isle of Conquest Siege Engine - main turret (horde) (Heroic)'),
(35433, 35417, 1, 1, 'Isle of Conquest Siege Engine - flame turret 1 (horde) (Heroic)'),
(35433, 35417, 2, 1, 'Isle of Conquest Siege Engine - flame turret 2 (horde) (Heroic)'),
...
(35431, 35436, 7, 1, 'Isle of Conquest Siege Engine  - main turret (ally) (Heroic)'),
(35431, 36358, 1, 1, 'Isle of Conquest Siege Engine  - flame turret 1 (ally) (Heroic)'),
(35431, 36358, 2, 1, 'Isle of Conquest Siege Engine  - flame turret 2 (ally) (Heroic)');
...
UPDATE `creature_template` SET `vehicle_id` = 87 WHERE `entry` = 28817; -- Mine Car (hack)
...
UPDATE creature_template SET InhabitType = 3,vehicle_id = 70,powerType=3 WHERE entry IN (27755,27756,27692);
...
UPDATE `creature_template` SET `spell1` = 69495 WHERE `entry` = 34929;
UPDATE `creature_template` SET `spell1` = 68825 WHERE `entry` = 34935;
UPDATE `creature_template` SET `spell1` = 68825, `spell2` = 68169 WHERE `entry` = 34944;
...
UPDATE `creature_template` SET `vehicle_id` = 232 WHERE `entry` = 30393;
UPDATE `creature_template` SET `vehicle_id` = 232 WHERE `entry` = 30420;
UPDATE `creature_template` SET `vehicle_id` = 237 WHERE `entry` = 30461;
UPDATE `creature_template` SET `vehicle_id` = 241 WHERE `entry` = 30388; -- Stormhoof
UPDATE `creature_template` SET `vehicle_id` = 276 WHERE `entry` = 31432;